...
import { as as Route, S as SiteHeader, e as SiteFooter } from "./router-BPpbotmS.js";
import "react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/10 via-background to-background", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-4 py-14 sm:py-20", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mt-5 max-w-2xl text-lg text-muted-foreground", children: [
            ...
            " — private pools near me in every US city — organized by state and city. Browse every US city where you can rent a swimming pool by the hour. $2M liability insurance included on every booking, 0% host fees through 2026, no memberships."
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-4 py-12", children: [
        ...
        /* @__PURE__ */ jsxs("section", { "aria-label": "Popular pool rentals", className: "mt-12", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold tracking-tight sm:text-3xl", children: "Popular pool rentals" }),
          /* @__PURE__ */ jsxs("nav", { className: "mt-4 flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsx("a", { href: "/p/new-york-ny", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental New York" }),
            /* @__PURE__ */ jsx("a", { href: "/p/san-diego-ca", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental San Diego" }),
            /* @__PURE__ */ jsx("a", { href: "/p/atlanta", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental Atlanta" }),
            /* @__PURE__ */ jsx("a", { href: "/p/riverside", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental Riverside, CA" }),
            /* @__PURE__ */ jsx("a", { href: "/p/las-vegas-search-page", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rentals in Las Vegas" }),
            /* @__PURE__ */ jsx("a", { href: "/p/sacramentobestprivatepools", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Private pool rental Sacramento" }),
            /* @__PURE__ */ jsx("a", { href: "/p/allentown", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental Allentown, PA" }),
            /* @__PURE__ */ jsx("a", { href: "/p/annapolis", className: "rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition hover:border-primary hover:text-primary", children: "Pool rental Annapolis, MD" })
          ] })
        ] }),
