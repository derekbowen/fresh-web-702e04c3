...
import { D as DEFAULT_FOOTER } from "./site-footer-defaults-C6_J6kuR.js";
...
import { sendDueEmails, pollSharetribeRenters } from "./renter-drip.server-BUH95fZo.js";
import { sendDueHostEmails, pollSharetribeHosts } from "./host-drip.server-MvSzhhAo.js";
...
const appCss = "/fw-assets/styles-Y4Inso5R.css";
...
const IntercomWidget = lazy(
  () => import("./intercom-widget-BYzx4Hd-.js").then((m) => ({ default: m.IntercomWidget }))
);
...
const Route$3l = createRootRoute({
  loader: async () => {
...
function RootComponent() {
  ...
  const data = Route$3l.useLoaderData();
...
const $$splitComponentImporter$20 = () => import("./unsubscribe-renter-DFTMClQv.js");
const Route$3k = createFileRoute("/unsubscribe-renter")({
  validateSearch: (s) => ({
    token: String(s.token || "")
  }),
  component: lazyRouteComponent($$splitComponentImporter$20, "component")
});
const $$splitComponentImporter$1$ = () => import("./unsubscribe-host-M3gZcNGC.js");
const Route$3j = createFileRoute("/unsubscribe-host")({
  validateSearch: (s) => ({
    token: String(s.token || "")
  }),
  component: lazyRouteComponent($$splitComponentImporter$1$, "component")
});
const $$splitComponentImporter$1_ = () => import("./unsubscribe-composer-BaWudsQf.js");
const Route$3i = createFileRoute("/unsubscribe-composer")({
  validateSearch: (s) => ({
    token: String(s.token || "")
  }),
  component: lazyRouteComponent($$splitComponentImporter$1_, "component")
});
const $$splitComponentImporter$1Z = () => import("./unsubscribe-scF4ADGK.js");
const searchSchema$1 = z.object({
  token: z.string().optional()
});
const Route$3h = createFileRoute("/unsubscribe")({
...
const Route$3g = createFileRoute("/sm-74buq58v.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3f = createFileRoute("/sm-74buq58v-ls.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3e = createFileRoute("/sm-74buq58v-ho.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3d = createFileRoute("/sm-74buq58v-ev.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3c = createFileRoute("/sm-74buq58v-cr.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3b = createFileRoute("/sm-74buq58v-cn.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$3a = createFileRoute("/sm-74buq58v-ad.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
...
const Route$39 = createFileRoute("/sitemap.xml")({
  server: {
    handlers: {
      GET: async () => {
        const entries = [];
...
const Route$38 = createFileRoute("/sitemap-static.xml")({
  server: {
    handlers: {
      GET: async () => {
...
const Route$37 = createFileRoute("/sitemap-recent-pages.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$36 = createFileRoute("/sitemap-pages-swim-instructor.xml")({
  server: {
    handlers: {
...
const Route$35 = createFileRoute("/sitemap-pages-spanish.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => buildContentPagesSitemap(
        request,
...
const Route$34 = createFileRoute("/sitemap-pages-money.xml")({
  server: {
    handlers: {
...
const Route$33 = createFileRoute("/sitemap-pages-host-acquisition.xml")({
  server: {
    handlers: {
...
const Route$32 = createFileRoute("/sitemap-pages-event-guides.xml")({
  server: {
    handlers: {
...
const Route$31 = createFileRoute("/sitemap-pages-courses.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const url = new URL(request.url);
...
const Route$30 = createFileRoute("/sitemap-pages-comparisons.xml")({
  server: {
    handlers: {
      GET: async () => {
        const now = /* @__PURE__ */ new Date();
...
const Route$2$ = createFileRoute("/sitemap-pages-cities.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => buildContentPagesSitemap(
        request,
...
const Route$2_ = createFileRoute("/sitemap-pages-blog.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const url = new URL(request.url);
...
const Route$2Z = createFileRoute("/sitemap-pages-articles.xml")({
  server: {
    handlers: {
...
const Route$2Y = createFileRoute("/sitemap-pages-advocacy.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => buildContentPagesSitemap(
        request,
...
const Route$2X = createFileRoute("/sitemap-pages-academy.xml")({
  server: {
    handlers: {
...
const Route$2W = createFileRoute("/sitemap-listings.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const url = new URL(request.url);
...
const Route$2V = createFileRoute("/sitemap-index.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const Route$2U = createFileRoute("/sitemap-hub.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
createServerFn({
  method: "GET"
...
const Route$2T = createFileRoute("/sitemap-directory.xml")({
  server: {
    handlers: {
      GET: async () => {
...
const Route$2S = createFileRoute("/sitemap-default.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
const PROD_HOST = "poolrentalnearme.com";
const Route$2R = createFileRoute("/robots.txt")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const host = (() => {
...
const Route$2Q = createFileRoute("/pools-directory-sitemap.xml")({
  server: { handlers: { GET: () => redirect301("/sitemap.xml", SITE_URL) } }
});
...
const heroImage$3 = "/fw-assets/hero-family-pool-B63SS9RY.jpg";
...
const HOMEPAGE_HERO_IMAGE = heroImage$3;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
        ...
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative mx-auto flex min-h-[60vh] max-w-3xl flex-col items-center justify-center px-4 py-12 text-center text-white sm:py-16 lg:py-24", children: [
              /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold leading-tight tracking-tight drop-shadow-md sm:text-5xl lg:text-6xl", children: "Rent a private pool by the hour" }),
              /* @__PURE__ */ jsx("p", { className: "mx-auto mt-4 max-w-xl text-base text-white/95 drop-shadow sm:text-lg", children: "Find a private pool for rent by the hour, anywhere in America. From quiet family days to full pool party rentals." }),
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-4 py-10 text-center text-white sm:py-14", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "mx-auto mt-5 max-w-2xl text-xl font-semibold leading-snug text-white sm:text-2xl", children: [
              /* @__PURE__ */ jsx("span", { className: "text-gold", children: "Thank you." }),
      ...
      /* @__PURE__ */ jsx("section", { "aria-label": "Two ways to use Pool Rental Near Me", className: "bg-background", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-center text-2xl font-bold tracking-tight text-foreground sm:text-3xl", children: "Two ways to make summer happen." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Simple, affordable, and the best Saturday your kids will remember this summer." }),
                /* @__PURE__ */ jsx(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "text-4xl", "aria-hidden": true, children: "🌴" }),
                /* @__PURE__ */ jsx("h3", { className: "mt-3 text-xl font-semibold", children: "I'm sharing my pool" }),
                /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-white/90", children: "Earn $3K-$10K a month renting your pool by the hour. $2M Hartford-backed insurance and 0% host fees through 2026 — you keep 100%." }),
                /* @__PURE__ */ jsx(
                  "span",
                  {
        ...
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-7", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-start gap-4 sm:gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative flex-shrink-0", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "absolute -right-2 -top-1 inline-flex items-center rounded-full bg-gold px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-gold-foreground shadow-md sm:text-xs", children: "Your coach" })
            ] }),
            ...
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "aspect-[4/3] overflow-hidden bg-muted", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-gold px-2.5 py-1 text-[11px] font-bold text-gold-foreground shadow", children: "🏆 Top 9 Pools in LA 2025" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
...
const $$splitComponentImporter$1Y = () => import("./landing-page-_7zfMW8q.js");
...
const Route$2P = createFileRoute("/landing-page")({
  loader: async () => {
...
const Route$2O = createFileRoute("/jobs.xml")({
  server: {
    handlers: {
      GET: async ({ request }) => {
...
const Route$2N = createFileRoute("/blog")({
  server: {
    handlers: {
...
const $$splitComponentImporter$1X = () => import("./auth-BumfXi_e.js");
const SAFE_PATH = /^\/(?!\/|\\)[^\s]*$/;
...
const Route$2M = createFileRoute("/auth")({
...
const Route$2L = createFileRoute("/affiliate")({
  beforeLoad: () => {
    throw redirect({ to: "/p/affiliate-dashboard" });
  }
});
const $$splitComponentImporter$1W = () => import("./admin-BFsOu0JM.js");
const Route$2K = createFileRoute("/admin")({
  beforeLoad: async ({
    location
  }) => {
...
const $$splitComponentImporter$1V = () => import("./index-B2cB2o_h.js");
...
const Route$2J = createFileRoute("/")({
  loader: async () => {
    try {
...
const $$splitNotFoundComponentImporter$b = () => import("./verify._uid-CTG-WOzU.js");
const $$splitComponentImporter$1U = () => import("./verify._uid-BhggGgut.js");
const Route$2I = createFileRoute("/verify/$uid")({
  loader: async ({
    params
  }) => {
...
const Route$2H = createFileRoute("/technical-support/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
...
const Route$2G = createFileRoute("/pool-management/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const PATH$n = "/p/waiver-generator";
const FAQS$c = [{
...
const heroImage$2 = "/fw-assets/host-pro-hero-Byp59dwp.jpg";
const $$splitComponentImporter$1T = () => import("./p.waiver-generator-ARnHCIDk.js");
const PUBLISHED$6 = "2026-05-23T00:00:00Z";
const MODIFIED$6 = "2026-05-23T00:00:00Z";
const TITLE$o = "Pool waiver generator: free digital liability waivers for hosts | Pool Rental Near Me";
const DESCRIPTION$o = "Free pool waiver generator. Create a digital liability waiver every guest signs on their phone before arrival. State-aware language, PDF copies, host-ready.";
const Route$2F = createFileRoute("/p/waiver-generator")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$o,
...
const Route$2E = createFileRoute("/p/waitlist-signup")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body;
...
const $$splitComponentImporter$1S = () => import("./p.swimply-alternative-vs-pool-rental-near-me-CJRCfowl.js");
const SLUG$2 = "swimply-alternative-vs-pool-rental-near-me";
const TITLE$n = "Swimply vs Pool Rental Near Me: 2026 Comparison";
const DESCRIPTION$n = "Honest 2026 comparison of Swimply vs Pool Rental Near Me. PRNM charges 0% host commission through 2026 (down from 10%), includes $2M insurance, and ships 70+ free Pool Host Academy courses. Compare fees, insurance, training and reach.";
const Route$2D = createFileRoute("/p/swimply-alternative-vs-pool-rental-near-me")({
  ...
  head: () => ({
    ...
    scripts: [faqJsonLd$2(faqs$5.map((f) => ({
      q: f.q,
      a: f.a
    }))), articleJsonLd({
      slug: SLUG$2,
...
const heroImage$1 = "/fw-assets/hosting-hero-CJCu9RSc.jpg";
const $$splitComponentImporter$1R = () => import("./p.start-hosting-BQzFjmQ0.js");
const PUBLISHED$5 = "2026-05-23T00:00:00Z";
const MODIFIED$5 = "2026-05-23T00:00:00Z";
const TITLE$m = "Start hosting your pool: earn $1,500 to $8,000 a month | Pool Rental Near Me";
const DESCRIPTION$m = "Start hosting your pool on Pool Rental Near Me. 0% host fees through 2026, $2M liability included, free to list, 24-hour payouts. Be live in 15 minutes.";
const Route$2C = createFileRoute("/p/start-hosting")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$m,
...
const $$splitComponentImporter$1Q = () => import("./p.sharetribe-C0rItPsa.js");
const Route$2B = createFileRoute("/p/sharetribe")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1P = () => import("./p.private-pool-rental-CrRk2ywE.js");
const PATH$l = "/p/private-pool-rental";
const TITLE$l = "Private Pool Rental by the Hour | Pool Rental Near Me";
const DESCRIPTION$l = "Book a private pool rental by the hour. Heated pools, hot tubs, saltwater backyards. $2M liability included, hosts keep 100% of every booking.";
...
const Route$2A = createFileRoute("/p/private-pool-rental")({
  ...
  head: () => ({
    ...
    scripts: [ldJsonScript(serviceJsonLd$1), ldJsonScript(faqJsonLd$1), ldJsonScript(breadcrumb$1)]
  })
});
const $$splitComponentImporter$1O = () => import("./p.privacy-request-C9JIld1E.js");
const Route$2z = createFileRoute("/p/privacy-request")({
  head: () => ({
    meta: [{
...
const PATH$k = "/p/pool-wifi-guide";
const FAQS$9 = [{
...
const $$splitComponentImporter$1N = () => import("./p.pool-wifi-guide-D86PQHM1.js");
const PUBLISHED$4 = "2026-05-23T00:00:00Z";
const MODIFIED$4 = "2026-05-23T00:00:00Z";
const TITLE$k = "Pool wifi guide: setup, range, and guest access | Pool Rental Near Me";
const DESCRIPTION$k = "Free pool wifi guide for hosts. How to extend wifi to the pool, give guests safe limited access, hit 25+ Mbps poolside, and avoid the three setups that cause bad reviews.";
const Route$2y = createFileRoute("/p/pool-wifi-guide")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$k,
...
const PATH$j = "/p/pool-rules-generator";
const FAQS$8 = [{
...
const $$splitComponentImporter$1M = () => import("./p.pool-rules-generator-DfYq7pBr.js");
const PUBLISHED$3 = "2026-05-23T00:00:00Z";
const MODIFIED$3 = "2026-05-23T00:00:00Z";
const TITLE$j = "Pool rules generator: free house rules every guest signs | Pool Rental Near Me";
const DESCRIPTION$j = "Free pool rules generator for hosts. Build a clear, enforceable house-rules document in 60 seconds — guest count, hours, glass, smoking, music, kids, pets, more.";
const Route$2x = createFileRoute("/p/pool-rules-generator")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$j,
...
const $$splitComponentImporter$1L = () => import("./p.pool-rentals-__state_-B87jtsX8.js");
const $$splitErrorComponentImporter$d = () => import("./p.pool-rentals-__state_-Ckq3gbac.js");
const $$splitNotFoundComponentImporter$a = () => import("./p.pool-rentals-__state_-46lajec5.js");
const Route$2w = createFileRoute("/p/pool-rentals-{$state}")({
  loader: async ({
    params
  }) => {
    let data = null;
...
const $$splitComponentImporter$1K = () => import("./p.pool-rentals-Cu2xa-Qr.js");
const $$splitErrorComponentImporter$c = () => import("./p.pool-rentals-wPFp3KNc.js");
const Route$2v = createFileRoute("/p/pool-rentals")({
  loader: async () => {
...
const $$splitComponentImporter$1J = () => import("./p.pool-rental-permits-by-state-84jaH3E7.js");
const PATH$i = "/p/pool-rental-permits-by-state";
const TITLE$i = "Pool rental permits by state: 50-state guide for hourly pool hosts (2026)";
const DESCRIPTION$i = "What you legally need to host an hourly pool rental in each US state. Short-term rental registrations, business licenses, health-department rules, HOA exposure, and county-level callouts. Sourced from state and city code.";
const Route$2u = createFileRoute("/p/pool-rental-permits-by-state")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$i,
...
const $$splitComponentImporter$1I = () => import("./p.pool-rental-insurance-explained-BZTgd0yO.js");
const PATH$h = "/p/pool-rental-insurance-explained";
const TITLE$h = "Do You Need Insurance to Rent Out Your Pool? (2026)";
const DESCRIPTION$h = "Yes — most homeowners policies exclude paid pool rentals, so you need commercial liability coverage. Here's what you actually need, plus how Swimply, PRNM, Peerspace and Giggster compare on carriers, limits, and proof.";
const Route$2t = createFileRoute("/p/pool-rental-insurance-explained")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$h,
...
const $$splitComponentImporter$1H = () => import("./p.pool-rental-host-fees-compared-B1pT-juE.js");
const PATH$g = "/p/pool-rental-host-fees-compared";
const TITLE$g = "Pool Rental Host Fees Compared: Swimply, Peerspace, Giggster & PRNM (2026)";
const DESCRIPTION$g = "Side-by-side breakdown of what each pool-rental platform actually takes from a host booking. Published host commission, guest service fee, payout speed, and effective take-rate, sourced from each platform's terms.";
const Route$2s = createFileRoute("/p/pool-rental-host-fees-compared")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$g,
    ...
    return {
      ...
      scripts: [ldJsonScript({
        ...
        mainEntityOfPage: `${SITE_URL}${PATH$g}`
      }), ldJsonScript({
        "@context": "https://schema.org",
        "@type": "FAQPage",
...
const Route$2r = createFileRoute("/p/pool-rental-app")({
  beforeLoad: () => {
...
const $$splitComponentImporter$1G = () => import("./p.pool-pros-1MypseuH.js");
const Route$2q = createFileRoute("/p/pool-pros")({
  loader: async () => {
    const {
      providers
...
const $$splitComponentImporter$1F = () => import("./p.pool-party-rentals-Y_J0OK9s.js");
...
const Route$2p = createFileRoute("/p/pool-party-rentals")({
...
const $$splitComponentImporter$1E = () => import("./p.pool-heating-cost-calculator-Avvo_58c.js");
...
const Route$2o = createFileRoute("/p/pool-heating-cost-calculator")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$e,
...
const $$splitComponentImporter$1D = () => import("./p.peerspace-vs-pool-rental-near-me-in-__city_-Bf4P50GB.js");
const Route$2n = createFileRoute("/p/peerspace-vs-pool-rental-near-me-in-{$city}")({
  loader: async ({
    params
  }) => {
  ...
  head: ({
    ...
    return {
      ...
      scripts: [articleJsonLd({
        ...
        url: absUrl(`/p/${slug}`)
      }]), faqJsonLd$2(buildFaqs$1(city).map((f) => ({
        q: f.q,
        a: f.a
      })))]
    };
...
const $$splitComponentImporter$1C = () => import("./p.peerspace-vs-pool-rental-near-me-DxcGoaWf.js");
...
const Route$2m = createFileRoute("/p/peerspace-vs-pool-rental-near-me")({
  ...
  head: () => ({
    ...
    scripts: [faqJsonLd$2(faqs$1.map((f) => ({
      q: f.q,
      a: f.a
    }))), articleJsonLd({
      slug: SLUG$1,
...
const $$splitComponentImporter$1B = () => import("./p.neighbors-DmT5PkY9.js");
...
const Route$2l = createFileRoute("/p/neighbors")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$c,
...
const $$splitComponentImporter$1A = () => import("./p.lukes-lounge-C8le6MVO.js");
const LISTING_ID$1 = "68865990-2dec-4c64-a6a3-475f95ffe556";
const PATH$c = "/p/lukes-lounge";
const Route$2k = createFileRoute("/p/lukes-lounge")({
  loader: async () => {
    const origin = await getRouteOrigin();
    const {
      listing
...
const $$splitComponentImporter$1z = () => import("./p.la-saltwater-featured-9DNKv1i6.js");
...
const Route$2j = createFileRoute("/p/la-saltwater-featured")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$b,
...
const $$splitComponentImporter$1y = () => import("./p.jan-BeKrAeKI.js");
const LISTING_ID = "6a1a4c13-02fe-458e-89ba-e33b5fc7612b";
const PATH$a = "/p/jan";
const Route$2i = createFileRoute("/p/jan")({
  loader: async () => {
    const origin = await getRouteOrigin();
    const {
      listing
...
const $$splitComponentImporter$1x = () => import("./p.how-it-works-Cqw8Hj60.js");
const TITLE$a = "How Pool Rental Near Me Works | Book a Private Pool by the Hour";
...
const Route$2h = createFileRoute("/p/how-it-works")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$a,
...
const $$splitComponentImporter$1w = () => import("./p.hosting-D2YhGsQn.js");
...
const Route$2g = createFileRoute("/p/hosting")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$9,
...
const $$splitComponentImporter$1v = () => import("./p.host-marketing-playbook-B1w-JJwW.js");
...
const Route$2f = createFileRoute("/p/host-marketing-playbook")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$8,
...
const $$splitComponentImporter$1u = () => import("./p.giggster-vs-pool-rental-near-me-in-__city_-B78oy1Qj.js");
const Route$2e = createFileRoute("/p/giggster-vs-pool-rental-near-me-in-{$city}")({
  loader: async ({
    params
  }) => {
  ...
  head: ({
    ...
    return {
      ...
      scripts: [articleJsonLd({
        ...
        url: absUrl(`/p/${slug}`)
      }]), faqJsonLd$2(buildFaqs(city).map((f) => ({
        q: f.q,
        a: f.a
      })))]
    };
...
const $$splitComponentImporter$1t = () => import("./p.giggster-vs-pool-rental-near-me-y7IO46qQ.js");
...
const Route$2d = createFileRoute("/p/giggster-vs-pool-rental-near-me")({
  component: lazyRouteComponent($$splitComponentImporter$1t, "component"),
  head: () => ({
    ...buildComparisonMeta({
      slug: SLUG,
    ...
    scripts: [faqJsonLd$2(faqs.map((f) => ({
      q: f.q,
      a: f.a
    }))), articleJsonLd({
      slug: SLUG,
...
const $$splitComponentImporter$1s = () => import("./p.free-host-tools-6QliDoY9.js");
...
const Route$2c = createFileRoute("/p/free-host-tools")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$6,
...
const $$splitComponentImporter$1r = () => import("./p.earnings-calculator-DHE6un6t.js");
...
const Route$2b = createFileRoute("/p/earnings-calculator")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$5,
...
const Route$2a = createFileRoute("/p/dog")({
  beforeLoad: () => {
    throw redirect({
      to: "/admin/dashboard",
      replace: true
...
const $$splitComponentImporter$1p = () => import("./p.blog-BlROl6Rk.js");
const Route$29 = createFileRoute("/p/blog")({
  loader: async () => {
    const {
      posts
...
const $$splitComponentImporter$1o = () => import("./p.all-locations-DNuZODyf.js");
const Route$28 = createFileRoute("/p/all-locations")({
  loader: async () => {
...
const $$splitComponentImporter$1n = () => import("./p.ai-listing-generator-mii_R2jB.js");
...
const Route$27 = createFileRoute("/p/ai-listing-generator")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$4,
...
const $$splitComponentImporter$1m = () => import("./p.affiliate-program-BSEStGhn.js");
...
const Route$26 = createFileRoute("/p/affiliate-program")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$3,
...
const $$splitComponentImporter$1l = () => import("./p.affiliate-dashboard-oo5PMRhU.js");
const Route$25 = createFileRoute("/p/affiliate-dashboard")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$1k = () => import("./p.affiliate-B2EVWsQl.js");
...
const Route$24 = createFileRoute("/p/affiliate")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$2,
...
const $$splitComponentImporter$1j = () => import("./p.about-our-company-C--h8pAe.js");
...
const Route$23 = createFileRoute("/p/about-our-company")({
  head: () => {
    const meta = buildMeta({
      title: TITLE$1,
...
const $$splitNotFoundComponentImporter$7 = () => import("./p._slug-B_-ynfgZ.js");
const $$splitErrorComponentImporter$b = () => import("./p._slug-Cwm42Udw.js");
const $$splitComponentImporter$1i = () => import("./p._slug-Ctzf1FpY.js");
const Route$22 = createFileRoute("/p/$slug")({
  beforeLoad: async ({
    params
  }) => {
...
const Route$21 = createFileRoute("/p/$")({
  beforeLoad: ({
    params
  }) => {
    const splat = params._splat ?? "";
...
const Route$20 = createFileRoute("/marketing-and-growth/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1$ = createFileRoute("/legal-and-compliance/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1_ = createFileRoute("/host-information/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1Z = createFileRoute("/guest-information/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1Y = createFileRoute("/for-hosts/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1X = createFileRoute("/for-guests/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
        const splat = params._splat ?? "";
...
const Route$1W = createFileRoute("/email/unsubscribe")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const supabaseUrl = "https://qbzpjsiahqgyoazjurqy.supabase.co";
...
const Route$1V = createFileRoute("/blog/$")({
  server: {
    handlers: {
      GET: ({ params }) => {
...
const $$splitComponentImporter$1g = () => import("./auth.reset-password-C_LfCk6Z.js");
const Route$1U = createFileRoute("/auth/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$1g, "component"),
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1f = () => import("./admin.tech-docs-DVdge3pJ.js");
const Route$1T = createFileRoute("/admin/tech-docs")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1e = () => import("./admin.team-CqNk_PaX.js");
const Route$1S = createFileRoute("/admin/team")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$1d = () => import("./admin.social-lead-hunter-twZkXIwU.js");
const Route$1R = createFileRoute("/admin/social-lead-hunter")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$1c = () => import("./admin.sms-blast-DBkQlD0x.js");
const Route$1Q = createFileRoute("/admin/sms-blast")({
  head: () => buildMeta({
...
const $$splitComponentImporter$1b = () => import("./admin.site-footer-DPfFHDAy.js");
const Route$1P = createFileRoute("/admin/site-footer")({
  component: lazyRouteComponent($$splitComponentImporter$1b, "component")
});
const $$splitComponentImporter$1a = () => import("./admin.sharetribe-prune-HjNNJmCz.js");
const Route$1O = createFileRoute("/admin/sharetribe-prune")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$19 = () => import("./admin.sharetribe-CQz2CxUE.js");
const Route$1N = createFileRoute("/admin/sharetribe")({
  component: lazyRouteComponent($$splitComponentImporter$19, "component")
});
const $$splitComponentImporter$18 = () => import("./admin.seo-health-CREgLYAE.js");
const Route$1M = createFileRoute("/admin/seo-health")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$17 = () => import("./admin.seo-critic-BpPXWjoU.js");
const Route$1L = createFileRoute("/admin/seo-critic")({
...
const $$splitComponentImporter$16 = () => import("./admin.seo-coach-DHliZBkN.js");
const Route$1K = createFileRoute("/admin/seo-coach")({
  component: lazyRouteComponent($$splitComponentImporter$16, "component")
});
const $$splitComponentImporter$15 = () => import("./admin.scrape-import-C8e924L5.js");
const Route$1J = createFileRoute("/admin/scrape-import")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const Route$1I = createFileRoute("/admin/renter-drip")({
  component: lazyRouteComponent($$splitComponentImporter$14, "component")
});
const $$splitComponentImporter$13 = () => import("./admin.redirect-aliases-DGOXwzPN.js");
const Route$1H = createFileRoute("/admin/redirect-aliases")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$12 = () => import("./admin.rank-tracker-BTRF_eUp.js");
const Route$1G = createFileRoute("/admin/rank-tracker")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$11 = () => import("./admin.quick-page-NZQQSBEk.js");
const Route$1F = createFileRoute("/admin/quick-page")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$10 = () => import("./admin.prnm-coach-F0UBQAKx.js");
const Route$1E = createFileRoute("/admin/prnm-coach")({
  component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
const $$splitComponentImporter$$ = () => import("./admin.privacy-requests-6CskkrR5.js");
const Route$1D = createFileRoute("/admin/privacy-requests")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitErrorComponentImporter$a = () => import("./admin.plan-requests-w3NZ-zXx.js");
const $$splitComponentImporter$_ = () => import("./admin.plan-requests-Dkg4rK2C.js");
const Route$1C = createFileRoute("/admin/plan-requests")({
...
const $$splitComponentImporter$Z = () => import("./admin.page-health-DsU81YSl.js");
const Route$1B = createFileRoute("/admin/page-health")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$Y = () => import("./admin.page-auditor-BQ56UJmo.js");
const Route$1A = createFileRoute("/admin/page-auditor")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$X = () => import("./admin.opportunities-Drgbsi4S.js");
const Route$1z = createFileRoute("/admin/opportunities")({
  component: lazyRouteComponent($$splitComponentImporter$X, "component")
});
const $$splitComponentImporter$W = () => import("./admin.no-access-DeGXs0xu.js");
const Route$1y = createFileRoute("/admin/no-access")({
  beforeLoad: async () => {
    const {
      data
    } = await supabase.auth.getUser();
...
const $$splitComponentImporter$V = () => import("./admin.missing-pages-9PztDZfv.js");
const Route$1x = createFileRoute("/admin/missing-pages")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$U = () => import("./admin.marketplace-Ilac53Uc.js");
const Route$1w = createFileRoute("/admin/marketplace")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$T = () => import("./admin.listing-auditor-CexZmTGZ.js");
const Route$1v = createFileRoute("/admin/listing-auditor")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$S = () => import("./admin.link-checker-BVQXTiTG.js");
const Route$1u = createFileRoute("/admin/link-checker")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$R = () => import("./admin.link-auto-repair-04RWNhpz.js");
const Route$1t = createFileRoute("/admin/link-auto-repair")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$Q = () => import("./admin.link-audit-C_xshHit.js");
const Route$1s = createFileRoute("/admin/link-audit")({
  component: lazyRouteComponent($$splitComponentImporter$Q, "component")
});
const $$splitComponentImporter$P = () => import("./admin.learning-BWQtqL5l.js");
const Route$1r = createFileRoute("/admin/learning")({
  beforeLoad: async ({
    location
  }) => {
    const {
...
const $$splitComponentImporter$O = () => import("./admin.leads-B1PNIyn5.js");
const Route$1q = createFileRoute("/admin/leads")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$N = () => import("./admin.landing-link-check-D0DfAbyU.js");
const Route$1p = createFileRoute("/admin/landing-link-check")({
  component: lazyRouteComponent($$splitComponentImporter$N, "component")
});
const $$splitComponentImporter$M = () => import("./admin.keyword-opportunities-DFSLP0mD.js");
const Route$1o = createFileRoute("/admin/keyword-opportunities")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$L = () => import("./admin.job-history-BhHZtZd0.js");
const Route$1n = createFileRoute("/admin/job-history")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$K = () => import("./admin.internal-links-vj-TIOav.js");
const Route$1m = createFileRoute("/admin/internal-links")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$J = () => import("./admin.indexing-Cb-DIMD1.js");
const Route$1l = createFileRoute("/admin/indexing")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$I = () => import("./admin.ig-lead-hunter-D3-wZeyv.js");
const Route$1k = createFileRoute("/admin/ig-lead-hunter")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const Route$1j = createFileRoute("/admin/host-drip")({
  component: lazyRouteComponent($$splitComponentImporter$H, "component")
});
const $$splitComponentImporter$G = () => import("./admin.gsc-import-NQVOBzBM.js");
const Route$1i = createFileRoute("/admin/gsc-import")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$F = () => import("./admin.generate-content-iVPvcLR8.js");
const Route$1h = createFileRoute("/admin/generate-content")({
  component: lazyRouteComponent($$splitComponentImporter$F, "component")
});
const $$splitComponentImporter$E = () => import("./admin.founder-blast-khodX6RC.js");
const Route$1g = createFileRoute("/admin/founder-blast")({
  head: () => buildMeta({
...
const $$splitComponentImporter$D = () => import("./admin.followup-reminders-jQGZGl2X.js");
const Route$1f = createFileRoute("/admin/followup-reminders")({
  component: lazyRouteComponent($$splitComponentImporter$D, "component")
});
const $$splitComponentImporter$C = () => import("./admin.followup-performance-D0rlgttj.js");
const Route$1e = createFileRoute("/admin/followup-performance")({
  component: lazyRouteComponent($$splitComponentImporter$C, "component")
});
const $$splitComponentImporter$B = () => import("./admin.followup-drilldown-OiwAKTzV.js");
const searchSchema = z.object({
...
const Route$1d = createFileRoute("/admin/followup-drilldown")({
  validateSearch: zodValidator(searchSchema),
  component: lazyRouteComponent($$splitComponentImporter$B, "component")
});
const $$splitComponentImporter$A = () => import("./admin.follow-ups-7J-zF5k0.js");
const Route$1c = createFileRoute("/admin/follow-ups")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./admin.faq-generator-yXeHtfBD.js");
const Route$1b = createFileRoute("/admin/faq-generator")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./admin.email-verify-CTXF8xmh.js");
const Route$1a = createFileRoute("/admin/email-verify")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$x = () => import("./admin.email-queue-CGOxZ5_y.js");
const Route$19 = createFileRoute("/admin/email-queue")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$w = () => import("./admin.email-deliverability-DlqiCf3m.js");
const Route$18 = createFileRoute("/admin/email-deliverability")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$v = () => import("./admin.email-composer-D-vf8otz.js");
const Route$17 = createFileRoute("/admin/email-composer")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component"),
  errorComponent: lazyRouteComponent($$splitErrorComponentImporter$9, "errorComponent")
});
const $$splitComponentImporter$u = () => import("./admin.email-branding-BLf8wXuE.js");
const Route$16 = createFileRoute("/admin/email-branding")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$t = () => import("./admin.drip-subscribers-DVyas9NV.js");
const Route$15 = createFileRoute("/admin/drip-subscribers")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./admin.directory-CZFTvyaY.js");
const Route$14 = createFileRoute("/admin/directory")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$r = () => import("./admin.data-import-B9HTgRyi.js");
const Route$13 = createFileRoute("/admin/data-import")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$q = () => import("./admin.data-export-DwqQSQSK.js");
const Route$12 = createFileRoute("/admin/data-export")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$p = () => import("./admin.dashboard-XuGnxIHv.js");
const Route$11 = createFileRoute("/admin/dashboard")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$o = () => import("./admin.content-pages-D35lAD5e.js");
const Route$10 = createFileRoute("/admin/content-pages")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$n = () => import("./admin.content-migration-DObdy13m.js");
const Route$$ = createFileRoute("/admin/content-migration")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$m = () => import("./admin.content-health-DKFdLc_-.js");
const Route$_ = createFileRoute("/admin/content-health")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$l = () => import("./admin.competitors-CychfOs0.js");
const Route$Z = createFileRoute("/admin/competitors")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$k = () => import("./admin.competitor-radar-Caiz_gz3.js");
const Route$Y = createFileRoute("/admin/competitor-radar")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$j = () => import("./admin.click-report-DO1azdpO.js");
const Route$X = createFileRoute("/admin/click-report")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitErrorComponentImporter$8 = () => import("./admin.claims-P-Xzoni4.js");
const $$splitComponentImporter$i = () => import("./admin.claims-DFYaXfN4.js");
const Route$W = createFileRoute("/admin/claims")({
...
const $$splitComponentImporter$h = () => import("./admin.cities-heroes-report-CzBqVVhM.js");
const Route$V = createFileRoute("/admin/cities-heroes-report")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$g = () => import("./admin.cities-heroes-Bp-E_Znd.js");
const Route$U = createFileRoute("/admin/cities-heroes")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$f = () => import("./admin.blog-BXdnXEVR.js");
const Route$T = createFileRoute("/admin/blog")({
  beforeLoad: async ({
    location
  }) => {
    const {
...
const $$splitComponentImporter$e = () => import("./admin.auto-refresh--6HdXcWp.js");
const Route$S = createFileRoute("/admin/auto-refresh")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitErrorComponentImporter$7 = () => import("./admin.auto-outreach-_d1-MKEp.js");
const $$splitComponentImporter$d = () => import("./admin.auto-outreach-y-C6rKBr.js");
const Route$R = createFileRoute("/admin/auto-outreach")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component"),
...
const $$splitComponentImporter$c = () => import("./admin.affiliates-CPTR_27F.js");
const Route$Q = createFileRoute("/admin/affiliates")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$b = () => import("./admin.add-contacts-Cu5K2Yxt.js");
const Route$P = createFileRoute("/admin/add-contacts")({
  beforeLoad: async () => {
    const {
      data,
      error
...
const $$splitComponentImporter$a = () => import("./admin.activity-cities-BMjnT2ov.js");
const Route$O = createFileRoute("/admin/activity-cities")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./account.learning-D_8rup3U.js");
const Route$N = createFileRoute("/account/learning")({
  beforeLoad: async ({
    location
  }) => {
    const {
...
const $$splitNotFoundComponentImporter$6 = () => import("./p.pool-pros._slug-DUfmZeqP.js");
const $$splitErrorComponentImporter$6 = () => import("./p.pool-pros._slug-Bx1MgF7t.js");
const $$splitComponentImporter$8 = () => import("./p.pool-pros._slug-D8GMPXpM.js");
const Route$M = createFileRoute("/p/pool-pros/$slug")({
  loader: async ({
    params
  }) => {
    const {
...
const $$splitNotFoundComponentImporter$5 = () => import("./p.es._slug-CMvSOFMe.js");
const $$splitErrorComponentImporter$5 = () => import("./p.es._slug-D0qLmpNn.js");
const $$splitComponentImporter$7 = () => import("./p.es._slug-DDeYzQfs.js");
const ES_TO_EN_SLUG = {
...
const Route$L = createFileRoute("/p/es/$slug")({
  beforeLoad: async ({
    params
  }) => {
...
const $$splitNotFoundComponentImporter$4 = () => import("./p.course._slug-CYz8of9E.js");
const $$splitErrorComponentImporter$4 = () => import("./p.course._slug-DZeSG7kd.js");
const $$splitComponentImporter$6 = () => import("./p.course._slug-Bpv-rSQn.js");
const Route$K = createFileRoute("/p/course/$slug")({
  loader: async ({
    params
  }) => {
    const {
...
const $$splitComponentImporter$5 = () => import("./p.author.derek-bowen-BWhRA2OP.js");
...
const Route$J = createFileRoute("/p/author/derek-bowen")({
  head: () => {
    const meta = buildMeta({
      title: TITLE,
...
const Route$I = createFileRoute("/lovable/email/suppression")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
function extractEmail(evt) {
  const candidate = evt.email || evt.recipient || evt.to || evt.data && (evt.data.email || evt.data.recipient || evt.data.to);
...
const Route$H = createFileRoute("/lovable/email/emailit-webhook")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        if (type.includes("bounce") || type === "bounced") {
          ...
          if (hard) {
            await supabase2.from("suppressed_emails").upsert(
              { email, reason: "bounce", metadata: evt },
              { onConflict: "email" }
            );
        ...
        if (type.includes("complaint") || type.includes("spam")) {
          if (!email) return Response.json({ ok: true, skipped: "no_email" });
          await supabase2.from("suppressed_emails").upsert(
            { email, reason: "complaint", metadata: evt },
            { onConflict: "email" }
          );
          await supabase2.from("email_send_log").insert({
            message_id: messageId,
...
const $$splitNotFoundComponentImporter$3 = () => import("./l._slug._id-uFGswnC8.js");
const $$splitErrorComponentImporter$3 = () => import("./l._slug._id-rWuT2A0O.js");
const $$splitComponentImporter$4 = () => import("./l._slug._id-CwHpvChd.js");
const Route$G = createFileRoute("/l/$slug/$id")({
  loader: async ({
    params
  }) => {
    const {
...
const Route$F = createFileRoute("/api/public/track-city-click")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let parsed;
...
const Route$E = createFileRoute("/api/public/link-health")({
  server: {
    handlers: {
...
const Route$D = createFileRoute("/api/public/backfill-content-pages")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body = {};
...
const Route$C = createFileRoute("/api/admin/data-export")({
  server: {
    handlers: {
      GET: async ({ request }) => {
...
const $$splitComponentImporter$3 = () => import("./admin.learning._userId-CRta0FQk.js");
const Route$B = createFileRoute("/admin/learning/$userId")({
  beforeLoad: async ({
    location
  }) => {
    const {
...
const $$splitErrorComponentImporter$2 = () => import("./p.pool-pros.c._category-DEYopHbc.js");
const $$splitNotFoundComponentImporter$2 = () => import("./p.pool-pros.c._category-Bv5PV-ml.js");
const $$splitComponentImporter$2 = () => import("./p.pool-pros.c._category-V-hdRT9R.js");
const Route$A = createFileRoute("/p/pool-pros/c/$category")({
  loader: async ({
    params
  }) => {
...
const Route$z = createFileRoute("/lovable/email/transactional/send")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const supabaseUrl = "https://qbzpjsiahqgyoazjurqy.supabase.co";
...
const Route$y = createFileRoute("/lovable/email/transactional/preview")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const apiKey = process.env.LOVABLE_API_KEY;
...
const Route$x = createFileRoute("/lovable/email/queue/process")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const Route$w = createFileRoute("/lovable/email/auth/webhook")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const apiKey = process.env.LOVABLE_API_KEY;
...
const Route$v = createFileRoute("/lovable/email/auth/preview")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const apiKey = process.env.LOVABLE_API_KEY;
...
const Route$u = createFileRoute("/api/public/hooks/twilio-inbound")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const Route$t = createFileRoute("/api/public/hooks/sync-sharetribe-mirror")({
  server: {
    handlers: {
...
const Route$s = createFileRoute("/api/public/hooks/sync-listings")({
  server: {
    handlers: {
...
const Route$r = createFileRoute("/api/public/hooks/sync-affiliate-commissions")({
  server: {
    handlers: {
...
const Route$q = createFileRoute("/api/public/hooks/sms-sender")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$p = createFileRoute("/api/public/hooks/seo-self-test")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$o = createFileRoute("/api/public/hooks/seo-fix-worker")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$n = createFileRoute("/api/public/hooks/send-renter-emails")({
  server: {
    handlers: {
...
const Route$m = createFileRoute("/api/public/hooks/send-host-drip-emails")({
  server: {
    handlers: {
...
const Route$l = createFileRoute("/api/public/hooks/provider-ai-worker")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$k = createFileRoute("/api/public/hooks/poll-sharetribe-renters")({
  server: {
    handlers: {
...
const Route$j = createFileRoute("/api/public/hooks/poll-sharetribe-hosts")({
  server: {
    handlers: {
...
const Route$i = createFileRoute("/api/public/hooks/link-auto-fix")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$h = createFileRoute("/api/public/hooks/intercom-sync")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$g = createFileRoute("/api/public/hooks/intercom")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const Route$f = createFileRoute("/api/public/hooks/ig-lead-hunter")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$e = createFileRoute("/api/public/hooks/host-city-tail-fix")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$d = createFileRoute("/api/public/hooks/gsc-sync")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$c = createFileRoute("/api/public/hooks/gen-host-pages")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const Route$b = createFileRoute("/api/public/hooks/followup-reminders")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        const unauth = await authorizeHookRequest(request);
...
const $$splitErrorComponentImporter$1 = () => import("./p.pool-pros.c._category._state-6iqoKnn5.js");
const $$splitNotFoundComponentImporter$1 = () => import("./p.pool-pros.c._category._state-JFOgppz6.js");
const $$splitComponentImporter$1 = () => import("./p.pool-pros.c._category._state-D2qt22kY.js");
...
const $$splitErrorComponentImporter = () => import("./p.pool-pros.c._category._state._city-YrroDEky.js");
const $$splitNotFoundComponentImporter = () => import("./p.pool-pros.c._category._state._city-CGpkk8ZF.js");
const $$splitComponentImporter = () => import("./p.pool-pros.c._category._state._city-DdW7hELq.js");
...
const UnsubscribeRenterRoute = Route$3k.update({
  id: "/unsubscribe-renter",
  path: "/unsubscribe-renter",
  getParentRoute: () => Route$3l
});
const UnsubscribeHostRoute = Route$3j.update({
  id: "/unsubscribe-host",
  path: "/unsubscribe-host",
  getParentRoute: () => Route$3l
});
const UnsubscribeComposerRoute = Route$3i.update({
  id: "/unsubscribe-composer",
  path: "/unsubscribe-composer",
  getParentRoute: () => Route$3l
});
const UnsubscribeRoute = Route$3h.update({
  id: "/unsubscribe",
  path: "/unsubscribe",
  getParentRoute: () => Route$3l
});
const Sm74buq58vDotxmlRoute = Route$3g.update({
  id: "/sm-74buq58v.xml",
  path: "/sm-74buq58v.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vLsDotxmlRoute = Route$3f.update({
  id: "/sm-74buq58v-ls.xml",
  path: "/sm-74buq58v-ls.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vHoDotxmlRoute = Route$3e.update({
  id: "/sm-74buq58v-ho.xml",
  path: "/sm-74buq58v-ho.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vEvDotxmlRoute = Route$3d.update({
  id: "/sm-74buq58v-ev.xml",
  path: "/sm-74buq58v-ev.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vCrDotxmlRoute = Route$3c.update({
  id: "/sm-74buq58v-cr.xml",
  path: "/sm-74buq58v-cr.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vCnDotxmlRoute = Route$3b.update({
  id: "/sm-74buq58v-cn.xml",
  path: "/sm-74buq58v-cn.xml",
  getParentRoute: () => Route$3l
});
const Sm74buq58vAdDotxmlRoute = Route$3a.update({
  id: "/sm-74buq58v-ad.xml",
  path: "/sm-74buq58v-ad.xml",
  getParentRoute: () => Route$3l
});
const SitemapDotxmlRoute = Route$39.update({
  id: "/sitemap.xml",
  path: "/sitemap.xml",
  getParentRoute: () => Route$3l
});
const SitemapStaticDotxmlRoute = Route$38.update({
  id: "/sitemap-static.xml",
  path: "/sitemap-static.xml",
  getParentRoute: () => Route$3l
});
const SitemapRecentPagesDotxmlRoute = Route$37.update({
  id: "/sitemap-recent-pages.xml",
  path: "/sitemap-recent-pages.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesSwimInstructorDotxmlRoute = Route$36.update({
  id: "/sitemap-pages-swim-instructor.xml",
  path: "/sitemap-pages-swim-instructor.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesSpanishDotxmlRoute = Route$35.update({
  id: "/sitemap-pages-spanish.xml",
  path: "/sitemap-pages-spanish.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesMoneyDotxmlRoute = Route$34.update({
  id: "/sitemap-pages-money.xml",
  path: "/sitemap-pages-money.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesHostAcquisitionDotxmlRoute = Route$33.update({
  id: "/sitemap-pages-host-acquisition.xml",
  path: "/sitemap-pages-host-acquisition.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesEventGuidesDotxmlRoute = Route$32.update({
  id: "/sitemap-pages-event-guides.xml",
  path: "/sitemap-pages-event-guides.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesCoursesDotxmlRoute = Route$31.update({
  id: "/sitemap-pages-courses.xml",
  path: "/sitemap-pages-courses.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesComparisonsDotxmlRoute = Route$30.update({
  id: "/sitemap-pages-comparisons.xml",
  path: "/sitemap-pages-comparisons.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesCitiesDotxmlRoute = Route$2$.update({
  id: "/sitemap-pages-cities.xml",
  path: "/sitemap-pages-cities.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesBlogDotxmlRoute = Route$2_.update({
  id: "/sitemap-pages-blog.xml",
  path: "/sitemap-pages-blog.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesArticlesDotxmlRoute = Route$2Z.update({
  id: "/sitemap-pages-articles.xml",
  path: "/sitemap-pages-articles.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesAdvocacyDotxmlRoute = Route$2Y.update({
  id: "/sitemap-pages-advocacy.xml",
  path: "/sitemap-pages-advocacy.xml",
  getParentRoute: () => Route$3l
});
const SitemapPagesAcademyDotxmlRoute = Route$2X.update({
  id: "/sitemap-pages-academy.xml",
  path: "/sitemap-pages-academy.xml",
  getParentRoute: () => Route$3l
});
const SitemapListingsDotxmlRoute = Route$2W.update({
  id: "/sitemap-listings.xml",
  path: "/sitemap-listings.xml",
  getParentRoute: () => Route$3l
});
const SitemapIndexDotxmlRoute = Route$2V.update({
  id: "/sitemap-index.xml",
  path: "/sitemap-index.xml",
  getParentRoute: () => Route$3l
});
const SitemapHubDotxmlRoute = Route$2U.update({
  id: "/sitemap-hub.xml",
  path: "/sitemap-hub.xml",
  getParentRoute: () => Route$3l
});
const SitemapDirectoryDotxmlRoute = Route$2T.update({
  id: "/sitemap-directory.xml",
  path: "/sitemap-directory.xml",
  getParentRoute: () => Route$3l
});
const SitemapDefaultDotxmlRoute = Route$2S.update({
  id: "/sitemap-default.xml",
  path: "/sitemap-default.xml",
  getParentRoute: () => Route$3l
});
const RobotsDottxtRoute = Route$2R.update({
  id: "/robots.txt",
  path: "/robots.txt",
  getParentRoute: () => Route$3l
});
const PoolsDirectorySitemapDotxmlRoute = Route$2Q.update({
  id: "/pools-directory-sitemap.xml",
  path: "/pools-directory-sitemap.xml",
  getParentRoute: () => Route$3l
});
const LandingPageRoute = Route$2P.update({
  id: "/landing-page",
  path: "/landing-page",
  getParentRoute: () => Route$3l
});
const JobsDotxmlRoute = Route$2O.update({
  id: "/jobs.xml",
  path: "/jobs.xml",
  getParentRoute: () => Route$3l
});
const BlogRoute = Route$2N.update({
  id: "/blog",
  path: "/blog",
  getParentRoute: () => Route$3l
});
const AuthRoute = Route$2M.update({
  id: "/auth",
  path: "/auth",
  getParentRoute: () => Route$3l
});
const AffiliateRoute = Route$2L.update({
  id: "/affiliate",
  path: "/affiliate",
  getParentRoute: () => Route$3l
});
const AdminRoute = Route$2K.update({
  id: "/admin",
  path: "/admin",
  getParentRoute: () => Route$3l
});
const IndexRoute = Route$2J.update({
  id: "/",
  path: "/",
  getParentRoute: () => Route$3l
});
const VerifyUidRoute = Route$2I.update({
  id: "/verify/$uid",
  path: "/verify/$uid",
  getParentRoute: () => Route$3l
});
const TechnicalSupportSplatRoute = Route$2H.update({
  id: "/technical-support/$",
  path: "/technical-support/$",
  getParentRoute: () => Route$3l
});
const PoolManagementSplatRoute = Route$2G.update({
  id: "/pool-management/$",
  path: "/pool-management/$",
  getParentRoute: () => Route$3l
});
const PWaiverGeneratorRoute = Route$2F.update({
  id: "/p/waiver-generator",
  path: "/p/waiver-generator",
  getParentRoute: () => Route$3l
});
const PWaitlistSignupRoute = Route$2E.update({
  id: "/p/waitlist-signup",
  path: "/p/waitlist-signup",
  getParentRoute: () => Route$3l
});
const PSwimplyAlternativeVsPoolRentalNearMeRoute = Route$2D.update({
  id: "/p/swimply-alternative-vs-pool-rental-near-me",
  path: "/p/swimply-alternative-vs-pool-rental-near-me",
  getParentRoute: () => Route$3l
});
const PStartHostingRoute = Route$2C.update({
  id: "/p/start-hosting",
  path: "/p/start-hosting",
  getParentRoute: () => Route$3l
});
const PSharetribeRoute = Route$2B.update({
  id: "/p/sharetribe",
  path: "/p/sharetribe",
  getParentRoute: () => Route$3l
});
const PPrivatePoolRentalRoute = Route$2A.update({
  id: "/p/private-pool-rental",
  path: "/p/private-pool-rental",
  getParentRoute: () => Route$3l
});
const PPrivacyRequestRoute = Route$2z.update({
  id: "/p/privacy-request",
  path: "/p/privacy-request",
  getParentRoute: () => Route$3l
});
const PPoolWifiGuideRoute = Route$2y.update({
  id: "/p/pool-wifi-guide",
  path: "/p/pool-wifi-guide",
  getParentRoute: () => Route$3l
});
const PPoolRulesGeneratorRoute = Route$2x.update({
  id: "/p/pool-rules-generator",
  path: "/p/pool-rules-generator",
  getParentRoute: () => Route$3l
});
const PPoolRentalsChar123stateChar125Route = Route$2w.update({
  id: "/p/pool-rentals-{$state}",
  path: "/p/pool-rentals-{$state}",
  getParentRoute: () => Route$3l
});
const PPoolRentalsRoute = Route$2v.update({
  id: "/p/pool-rentals",
  path: "/p/pool-rentals",
  getParentRoute: () => Route$3l
});
const PPoolRentalPermitsByStateRoute = Route$2u.update({
  id: "/p/pool-rental-permits-by-state",
  path: "/p/pool-rental-permits-by-state",
  getParentRoute: () => Route$3l
});
const PPoolRentalInsuranceExplainedRoute = Route$2t.update({
  id: "/p/pool-rental-insurance-explained",
  path: "/p/pool-rental-insurance-explained",
  getParentRoute: () => Route$3l
});
const PPoolRentalHostFeesComparedRoute = Route$2s.update({
  id: "/p/pool-rental-host-fees-compared",
  path: "/p/pool-rental-host-fees-compared",
  getParentRoute: () => Route$3l
});
const PPoolRentalAppRoute = Route$2r.update({
  id: "/p/pool-rental-app",
  path: "/p/pool-rental-app",
  getParentRoute: () => Route$3l
});
const PPoolProsRoute = Route$2q.update({
  id: "/p/pool-pros",
  path: "/p/pool-pros",
  getParentRoute: () => Route$3l
});
const PPoolPartyRentalsRoute = Route$2p.update({
  id: "/p/pool-party-rentals",
  path: "/p/pool-party-rentals",
  getParentRoute: () => Route$3l
});
const PPoolHeatingCostCalculatorRoute = Route$2o.update({
  id: "/p/pool-heating-cost-calculator",
  path: "/p/pool-heating-cost-calculator",
  getParentRoute: () => Route$3l
});
const PPeerspaceVsPoolRentalNearMeInChar123cityChar125Route = Route$2n.update({
  id: "/p/peerspace-vs-pool-rental-near-me-in-{$city}",
  path: "/p/peerspace-vs-pool-rental-near-me-in-{$city}",
  getParentRoute: () => Route$3l
});
const PPeerspaceVsPoolRentalNearMeRoute = Route$2m.update({
  id: "/p/peerspace-vs-pool-rental-near-me",
  path: "/p/peerspace-vs-pool-rental-near-me",
  getParentRoute: () => Route$3l
});
const PNeighborsRoute = Route$2l.update({
  id: "/p/neighbors",
  path: "/p/neighbors",
  getParentRoute: () => Route$3l
});
const PLukesLoungeRoute = Route$2k.update({
  id: "/p/lukes-lounge",
  path: "/p/lukes-lounge",
  getParentRoute: () => Route$3l
});
const PLaSaltwaterFeaturedRoute = Route$2j.update({
  id: "/p/la-saltwater-featured",
  path: "/p/la-saltwater-featured",
  getParentRoute: () => Route$3l
});
const PJanRoute = Route$2i.update({
  id: "/p/jan",
  path: "/p/jan",
  getParentRoute: () => Route$3l
});
const PHowItWorksRoute = Route$2h.update({
  id: "/p/how-it-works",
  path: "/p/how-it-works",
  getParentRoute: () => Route$3l
});
const PHostingRoute = Route$2g.update({
  id: "/p/hosting",
  path: "/p/hosting",
  getParentRoute: () => Route$3l
});
const PHostMarketingPlaybookRoute = Route$2f.update({
  id: "/p/host-marketing-playbook",
  path: "/p/host-marketing-playbook",
  getParentRoute: () => Route$3l
});
const PGiggsterVsPoolRentalNearMeInChar123cityChar125Route = Route$2e.update({
  id: "/p/giggster-vs-pool-rental-near-me-in-{$city}",
  path: "/p/giggster-vs-pool-rental-near-me-in-{$city}",
  getParentRoute: () => Route$3l
});
const PGiggsterVsPoolRentalNearMeRoute = Route$2d.update({
  id: "/p/giggster-vs-pool-rental-near-me",
  path: "/p/giggster-vs-pool-rental-near-me",
  getParentRoute: () => Route$3l
});
const PFreeHostToolsRoute = Route$2c.update({
  id: "/p/free-host-tools",
  path: "/p/free-host-tools",
  getParentRoute: () => Route$3l
});
const PEarningsCalculatorRoute = Route$2b.update({
  id: "/p/earnings-calculator",
  path: "/p/earnings-calculator",
  getParentRoute: () => Route$3l
});
const PDogRoute = Route$2a.update({
  id: "/p/dog",
  path: "/p/dog",
  getParentRoute: () => Route$3l
});
const PBlogRoute = Route$29.update({
  id: "/p/blog",
  path: "/p/blog",
  getParentRoute: () => Route$3l
});
const PAllLocationsRoute = Route$28.update({
  id: "/p/all-locations",
  path: "/p/all-locations",
  getParentRoute: () => Route$3l
});
const PAiListingGeneratorRoute = Route$27.update({
  id: "/p/ai-listing-generator",
  path: "/p/ai-listing-generator",
  getParentRoute: () => Route$3l
});
const PAffiliateProgramRoute = Route$26.update({
  id: "/p/affiliate-program",
  path: "/p/affiliate-program",
  getParentRoute: () => Route$3l
});
const PAffiliateDashboardRoute = Route$25.update({
  id: "/p/affiliate-dashboard",
  path: "/p/affiliate-dashboard",
  getParentRoute: () => Route$3l
});
const PAffiliateRoute = Route$24.update({
  id: "/p/affiliate",
  path: "/p/affiliate",
  getParentRoute: () => Route$3l
});
const PAboutOurCompanyRoute = Route$23.update({
  id: "/p/about-our-company",
  path: "/p/about-our-company",
  getParentRoute: () => Route$3l
});
const PSlugRoute = Route$22.update({
  id: "/p/$slug",
  path: "/p/$slug",
  getParentRoute: () => Route$3l
});
const PSplatRoute = Route$21.update({
  id: "/p/$",
  path: "/p/$",
  getParentRoute: () => Route$3l
});
const MarketingAndGrowthSplatRoute = Route$20.update({
  id: "/marketing-and-growth/$",
  path: "/marketing-and-growth/$",
  getParentRoute: () => Route$3l
});
const LegalAndComplianceSplatRoute = Route$1$.update({
  id: "/legal-and-compliance/$",
  path: "/legal-and-compliance/$",
  getParentRoute: () => Route$3l
});
const HostInformationSplatRoute = Route$1_.update({
  id: "/host-information/$",
  path: "/host-information/$",
  getParentRoute: () => Route$3l
});
const GuestInformationSplatRoute = Route$1Z.update({
  id: "/guest-information/$",
  path: "/guest-information/$",
  getParentRoute: () => Route$3l
});
const ForHostsSplatRoute = Route$1Y.update({
  id: "/for-hosts/$",
  path: "/for-hosts/$",
  getParentRoute: () => Route$3l
});
const ForGuestsSplatRoute = Route$1X.update({
  id: "/for-guests/$",
  path: "/for-guests/$",
  getParentRoute: () => Route$3l
});
const EmailUnsubscribeRoute = Route$1W.update({
  id: "/email/unsubscribe",
  path: "/email/unsubscribe",
  getParentRoute: () => Route$3l
});
const BlogSplatRoute = Route$1V.update({
  id: "/$",
  path: "/$",
  getParentRoute: () => BlogRoute
});
const AuthResetPasswordRoute = Route$1U.update({
  id: "/reset-password",
  path: "/reset-password",
  getParentRoute: () => AuthRoute
});
const AdminTechDocsRoute = Route$1T.update({
  id: "/tech-docs",
  path: "/tech-docs",
  getParentRoute: () => AdminRoute
});
const AdminTeamRoute = Route$1S.update({
  id: "/team",
  path: "/team",
  getParentRoute: () => AdminRoute
});
const AdminSocialLeadHunterRoute = Route$1R.update({
  id: "/social-lead-hunter",
  path: "/social-lead-hunter",
  getParentRoute: () => AdminRoute
});
const AdminSmsBlastRoute = Route$1Q.update({
  id: "/sms-blast",
  path: "/sms-blast",
  getParentRoute: () => AdminRoute
});
const AdminSiteFooterRoute = Route$1P.update({
  id: "/site-footer",
  path: "/site-footer",
  getParentRoute: () => AdminRoute
});
const AdminSharetribePruneRoute = Route$1O.update({
  id: "/sharetribe-prune",
  path: "/sharetribe-prune",
  getParentRoute: () => AdminRoute
});
const AdminSharetribeRoute = Route$1N.update({
  id: "/sharetribe",
  path: "/sharetribe",
  getParentRoute: () => AdminRoute
});
const AdminSeoHealthRoute = Route$1M.update({
  id: "/seo-health",
  path: "/seo-health",
  getParentRoute: () => AdminRoute
});
const AdminSeoCriticRoute = Route$1L.update({
  id: "/seo-critic",
  path: "/seo-critic",
  getParentRoute: () => AdminRoute
});
const AdminSeoCoachRoute = Route$1K.update({
  id: "/seo-coach",
  path: "/seo-coach",
  getParentRoute: () => AdminRoute
});
const AdminScrapeImportRoute = Route$1J.update({
  id: "/scrape-import",
  path: "/scrape-import",
  getParentRoute: () => AdminRoute
});
const AdminRenterDripRoute = Route$1I.update({
  id: "/renter-drip",
  path: "/renter-drip",
  getParentRoute: () => AdminRoute
});
const AdminRedirectAliasesRoute = Route$1H.update({
  id: "/redirect-aliases",
  path: "/redirect-aliases",
  getParentRoute: () => AdminRoute
});
const AdminRankTrackerRoute = Route$1G.update({
  id: "/rank-tracker",
  path: "/rank-tracker",
  getParentRoute: () => AdminRoute
});
const AdminQuickPageRoute = Route$1F.update({
  id: "/quick-page",
  path: "/quick-page",
  getParentRoute: () => AdminRoute
});
const AdminPrnmCoachRoute = Route$1E.update({
  id: "/prnm-coach",
  path: "/prnm-coach",
  getParentRoute: () => AdminRoute
});
const AdminPrivacyRequestsRoute = Route$1D.update({
  id: "/privacy-requests",
  path: "/privacy-requests",
  getParentRoute: () => AdminRoute
});
const AdminPlanRequestsRoute = Route$1C.update({
  id: "/plan-requests",
  path: "/plan-requests",
  getParentRoute: () => AdminRoute
});
const AdminPageHealthRoute = Route$1B.update({
  id: "/page-health",
  path: "/page-health",
  getParentRoute: () => AdminRoute
});
const AdminPageAuditorRoute = Route$1A.update({
  id: "/page-auditor",
  path: "/page-auditor",
  getParentRoute: () => AdminRoute
});
const AdminOpportunitiesRoute = Route$1z.update({
  id: "/opportunities",
  path: "/opportunities",
  getParentRoute: () => AdminRoute
});
const AdminNoAccessRoute = Route$1y.update({
  id: "/no-access",
  path: "/no-access",
  getParentRoute: () => AdminRoute
});
const AdminMissingPagesRoute = Route$1x.update({
  id: "/missing-pages",
  path: "/missing-pages",
  getParentRoute: () => AdminRoute
});
const AdminMarketplaceRoute = Route$1w.update({
  id: "/marketplace",
  path: "/marketplace",
  getParentRoute: () => AdminRoute
});
const AdminListingAuditorRoute = Route$1v.update({
  id: "/listing-auditor",
  path: "/listing-auditor",
  getParentRoute: () => AdminRoute
});
const AdminLinkCheckerRoute = Route$1u.update({
  id: "/link-checker",
  path: "/link-checker",
  getParentRoute: () => AdminRoute
});
const AdminLinkAutoRepairRoute = Route$1t.update({
  id: "/link-auto-repair",
  path: "/link-auto-repair",
  getParentRoute: () => AdminRoute
});
const AdminLinkAuditRoute = Route$1s.update({
  id: "/link-audit",
  path: "/link-audit",
  getParentRoute: () => AdminRoute
});
const AdminLearningRoute = Route$1r.update({
  id: "/learning",
  path: "/learning",
  getParentRoute: () => AdminRoute
});
const AdminLeadsRoute = Route$1q.update({
  id: "/leads",
  path: "/leads",
  getParentRoute: () => AdminRoute
});
const AdminLandingLinkCheckRoute = Route$1p.update({
  id: "/landing-link-check",
  path: "/landing-link-check",
  getParentRoute: () => AdminRoute
});
const AdminKeywordOpportunitiesRoute = Route$1o.update({
  id: "/keyword-opportunities",
  path: "/keyword-opportunities",
  getParentRoute: () => AdminRoute
});
const AdminJobHistoryRoute = Route$1n.update({
  id: "/job-history",
  path: "/job-history",
  getParentRoute: () => AdminRoute
});
const AdminInternalLinksRoute = Route$1m.update({
  id: "/internal-links",
  path: "/internal-links",
  getParentRoute: () => AdminRoute
});
const AdminIndexingRoute = Route$1l.update({
  id: "/indexing",
  path: "/indexing",
  getParentRoute: () => AdminRoute
});
const AdminIgLeadHunterRoute = Route$1k.update({
  id: "/ig-lead-hunter",
  path: "/ig-lead-hunter",
  getParentRoute: () => AdminRoute
});
const AdminHostDripRoute = Route$1j.update({
  id: "/host-drip",
  path: "/host-drip",
  getParentRoute: () => AdminRoute
});
const AdminGscImportRoute = Route$1i.update({
  id: "/gsc-import",
  path: "/gsc-import",
  getParentRoute: () => AdminRoute
});
const AdminGenerateContentRoute = Route$1h.update({
  id: "/generate-content",
  path: "/generate-content",
  getParentRoute: () => AdminRoute
});
const AdminFounderBlastRoute = Route$1g.update({
  id: "/founder-blast",
  path: "/founder-blast",
  getParentRoute: () => AdminRoute
});
const AdminFollowupRemindersRoute = Route$1f.update({
  id: "/followup-reminders",
  path: "/followup-reminders",
  getParentRoute: () => AdminRoute
});
const AdminFollowupPerformanceRoute = Route$1e.update({
  id: "/followup-performance",
  path: "/followup-performance",
  getParentRoute: () => AdminRoute
});
const AdminFollowupDrilldownRoute = Route$1d.update({
  id: "/followup-drilldown",
  path: "/followup-drilldown",
  getParentRoute: () => AdminRoute
});
const AdminFollowUpsRoute = Route$1c.update({
  id: "/follow-ups",
  path: "/follow-ups",
  getParentRoute: () => AdminRoute
});
const AdminFaqGeneratorRoute = Route$1b.update({
  id: "/faq-generator",
  path: "/faq-generator",
  getParentRoute: () => AdminRoute
});
const AdminEmailVerifyRoute = Route$1a.update({
  id: "/email-verify",
  path: "/email-verify",
  getParentRoute: () => AdminRoute
});
const AdminEmailQueueRoute = Route$19.update({
  id: "/email-queue",
  path: "/email-queue",
  getParentRoute: () => AdminRoute
});
const AdminEmailDeliverabilityRoute = Route$18.update({
  id: "/email-deliverability",
  path: "/email-deliverability",
  getParentRoute: () => AdminRoute
});
const AdminEmailComposerRoute = Route$17.update({
  id: "/email-composer",
  path: "/email-composer",
  getParentRoute: () => AdminRoute
});
const AdminEmailBrandingRoute = Route$16.update({
  id: "/email-branding",
  path: "/email-branding",
  getParentRoute: () => AdminRoute
});
const AdminDripSubscribersRoute = Route$15.update({
  id: "/drip-subscribers",
  path: "/drip-subscribers",
  getParentRoute: () => AdminRoute
});
const AdminDirectoryRoute = Route$14.update({
  id: "/directory",
  path: "/directory",
  getParentRoute: () => AdminRoute
});
const AdminDataImportRoute = Route$13.update({
  id: "/data-import",
  path: "/data-import",
  getParentRoute: () => AdminRoute
});
const AdminDataExportRoute = Route$12.update({
  id: "/data-export",
  path: "/data-export",
  getParentRoute: () => AdminRoute
});
const AdminDashboardRoute = Route$11.update({
  id: "/dashboard",
  path: "/dashboard",
  getParentRoute: () => AdminRoute
});
const AdminContentPagesRoute = Route$10.update({
  id: "/content-pages",
  path: "/content-pages",
  getParentRoute: () => AdminRoute
});
const AdminContentMigrationRoute = Route$$.update({
  id: "/content-migration",
  path: "/content-migration",
  getParentRoute: () => AdminRoute
});
const AdminContentHealthRoute = Route$_.update({
  id: "/content-health",
  path: "/content-health",
  getParentRoute: () => AdminRoute
});
const AdminCompetitorsRoute = Route$Z.update({
  id: "/competitors",
  path: "/competitors",
  getParentRoute: () => AdminRoute
});
const AdminCompetitorRadarRoute = Route$Y.update({
  id: "/competitor-radar",
  path: "/competitor-radar",
  getParentRoute: () => AdminRoute
});
const AdminClickReportRoute = Route$X.update({
  id: "/click-report",
  path: "/click-report",
  getParentRoute: () => AdminRoute
});
const AdminClaimsRoute = Route$W.update({
  id: "/claims",
  path: "/claims",
  getParentRoute: () => AdminRoute
});
const AdminCitiesHeroesReportRoute = Route$V.update({
  id: "/cities-heroes-report",
  path: "/cities-heroes-report",
  getParentRoute: () => AdminRoute
});
const AdminCitiesHeroesRoute = Route$U.update({
  id: "/cities-heroes",
  path: "/cities-heroes",
  getParentRoute: () => AdminRoute
});
const AdminBlogRoute = Route$T.update({
  id: "/blog",
  path: "/blog",
  getParentRoute: () => AdminRoute
});
const AdminAutoRefreshRoute = Route$S.update({
  id: "/auto-refresh",
  path: "/auto-refresh",
  getParentRoute: () => AdminRoute
});
const AdminAutoOutreachRoute = Route$R.update({
  id: "/auto-outreach",
  path: "/auto-outreach",
  getParentRoute: () => AdminRoute
});
const AdminAffiliatesRoute = Route$Q.update({
  id: "/affiliates",
  path: "/affiliates",
  getParentRoute: () => AdminRoute
});
const AdminAddContactsRoute = Route$P.update({
  id: "/add-contacts",
  path: "/add-contacts",
  getParentRoute: () => AdminRoute
});
const AdminActivityCitiesRoute = Route$O.update({
  id: "/activity-cities",
  path: "/activity-cities",
  getParentRoute: () => AdminRoute
});
const AccountLearningRoute = Route$N.update({
  id: "/account/learning",
  path: "/account/learning",
  getParentRoute: () => Route$3l
});
const PPoolProsSlugRoute = Route$M.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => PPoolProsRoute
});
const PEsSlugRoute = Route$L.update({
  id: "/p/es/$slug",
  path: "/p/es/$slug",
  getParentRoute: () => Route$3l
});
const PCourseSlugRoute = Route$K.update({
  id: "/p/course/$slug",
  path: "/p/course/$slug",
  getParentRoute: () => Route$3l
});
const PAuthorDerekBowenRoute = Route$J.update({
  id: "/p/author/derek-bowen",
  path: "/p/author/derek-bowen",
  getParentRoute: () => Route$3l
});
const LovableEmailSuppressionRoute = Route$I.update({
  id: "/lovable/email/suppression",
  path: "/lovable/email/suppression",
  getParentRoute: () => Route$3l
});
const LovableEmailEmailitWebhookRoute = Route$H.update({
  id: "/lovable/email/emailit-webhook",
  path: "/lovable/email/emailit-webhook",
  getParentRoute: () => Route$3l
});
const LSlugIdRoute = Route$G.update({
  id: "/l/$slug/$id",
  path: "/l/$slug/$id",
  getParentRoute: () => Route$3l
});
const ApiPublicTrackCityClickRoute = Route$F.update({
  id: "/api/public/track-city-click",
  path: "/api/public/track-city-click",
  getParentRoute: () => Route$3l
});
const ApiPublicLinkHealthRoute = Route$E.update({
  id: "/api/public/link-health",
  path: "/api/public/link-health",
  getParentRoute: () => Route$3l
});
const ApiPublicBackfillContentPagesRoute = Route$D.update({
  id: "/api/public/backfill-content-pages",
  path: "/api/public/backfill-content-pages",
  getParentRoute: () => Route$3l
});
const ApiAdminDataExportRoute = Route$C.update({
  id: "/api/admin/data-export",
  path: "/api/admin/data-export",
  getParentRoute: () => Route$3l
});
const AdminLearningUserIdRoute = Route$B.update({
  id: "/$userId",
  path: "/$userId",
  getParentRoute: () => AdminLearningRoute
});
const PPoolProsCCategoryRoute = Route$A.update({
  id: "/c/$category",
  path: "/c/$category",
  getParentRoute: () => PPoolProsRoute
});
const LovableEmailTransactionalSendRoute = Route$z.update({
  id: "/lovable/email/transactional/send",
  path: "/lovable/email/transactional/send",
  getParentRoute: () => Route$3l
});
const LovableEmailTransactionalPreviewRoute = Route$y.update({
  id: "/lovable/email/transactional/preview",
  path: "/lovable/email/transactional/preview",
  getParentRoute: () => Route$3l
});
const LovableEmailQueueProcessRoute = Route$x.update({
  id: "/lovable/email/queue/process",
  path: "/lovable/email/queue/process",
  getParentRoute: () => Route$3l
});
const LovableEmailAuthWebhookRoute = Route$w.update({
  id: "/lovable/email/auth/webhook",
  path: "/lovable/email/auth/webhook",
  getParentRoute: () => Route$3l
});
const LovableEmailAuthPreviewRoute = Route$v.update({
  id: "/lovable/email/auth/preview",
  path: "/lovable/email/auth/preview",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksTwilioInboundRoute = Route$u.update({
  id: "/api/public/hooks/twilio-inbound",
  path: "/api/public/hooks/twilio-inbound",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSyncSharetribeMirrorRoute = Route$t.update({
  id: "/api/public/hooks/sync-sharetribe-mirror",
  path: "/api/public/hooks/sync-sharetribe-mirror",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSyncListingsRoute = Route$s.update({
  id: "/api/public/hooks/sync-listings",
  path: "/api/public/hooks/sync-listings",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSyncAffiliateCommissionsRoute = Route$r.update({
  id: "/api/public/hooks/sync-affiliate-commissions",
  path: "/api/public/hooks/sync-affiliate-commissions",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSmsSenderRoute = Route$q.update({
  id: "/api/public/hooks/sms-sender",
  path: "/api/public/hooks/sms-sender",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSeoSelfTestRoute = Route$p.update({
  id: "/api/public/hooks/seo-self-test",
  path: "/api/public/hooks/seo-self-test",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSeoFixWorkerRoute = Route$o.update({
  id: "/api/public/hooks/seo-fix-worker",
  path: "/api/public/hooks/seo-fix-worker",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSendRenterEmailsRoute = Route$n.update({
  id: "/api/public/hooks/send-renter-emails",
  path: "/api/public/hooks/send-renter-emails",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksSendHostDripEmailsRoute = Route$m.update({
  id: "/api/public/hooks/send-host-drip-emails",
  path: "/api/public/hooks/send-host-drip-emails",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksProviderAiWorkerRoute = Route$l.update({
  id: "/api/public/hooks/provider-ai-worker",
  path: "/api/public/hooks/provider-ai-worker",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksPollSharetribeRentersRoute = Route$k.update({
  id: "/api/public/hooks/poll-sharetribe-renters",
  path: "/api/public/hooks/poll-sharetribe-renters",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksPollSharetribeHostsRoute = Route$j.update({
  id: "/api/public/hooks/poll-sharetribe-hosts",
  path: "/api/public/hooks/poll-sharetribe-hosts",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksLinkAutoFixRoute = Route$i.update({
  id: "/api/public/hooks/link-auto-fix",
  path: "/api/public/hooks/link-auto-fix",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksIntercomSyncRoute = Route$h.update({
  id: "/api/public/hooks/intercom-sync",
  path: "/api/public/hooks/intercom-sync",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksIntercomRoute = Route$g.update({
  id: "/api/public/hooks/intercom",
  path: "/api/public/hooks/intercom",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksIgLeadHunterRoute = Route$f.update({
  id: "/api/public/hooks/ig-lead-hunter",
  path: "/api/public/hooks/ig-lead-hunter",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksHostCityTailFixRoute = Route$e.update({
  id: "/api/public/hooks/host-city-tail-fix",
  path: "/api/public/hooks/host-city-tail-fix",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksGscSyncRoute = Route$d.update({
  id: "/api/public/hooks/gsc-sync",
  path: "/api/public/hooks/gsc-sync",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksGenHostPagesRoute = Route$c.update({
  id: "/api/public/hooks/gen-host-pages",
  path: "/api/public/hooks/gen-host-pages",
  getParentRoute: () => Route$3l
});
const ApiPublicHooksFollowupRemindersRoute = Route$b.update({
...
const routeTree = Route$3l._addFileChildren(rootRouteChildren)._addFileTypes();
...
export {
  ...
  STEPS as a8,
  FAQS$4 as a9,
  relatedAdvocacyStates as aA,
  normalizeTitleVariant as aB,
  getVariantCopy as aC,
  AUTHOR_PERSON_JSONLD_REF as aD,
  academyHubPath as aE,
  FredMascot as aF,
  FloatingFredTip as aG,
  Route$22 as aH,
  academyLangForSlug as aI,
  resolveAcademyHero as aJ,
  processSeoFixQueue as aK,
  getSeoJobStatus as aL,
  listSeoBatches as aM,
  cancelQueuedSeoJobs as aN,
  ShowChromeOverride as aO,
  getSiteFooterAdmin as aP,
  resetSiteFooter as aQ,
  updateSiteFooter as aR,
  listSeoIssues as aS,
  enqueueSeoFixJobs as aT,
  aiFixContentPage as aU,
  adminListScrapeJobs as aV,
  adminScrapeProviderUrl as aW,
  Route$1C as aX,
  adminReviewPlanRequest as aY,
  list404s as aZ,
  createPageFor404 as a_,
  ACADEMY_HREF as aa,
  FAQS$3 as ab,
  BREADCRUMBS$1 as ac,
  FAQS$2 as ad,
  ...
  APP_URL as ai,
  Route$29 as aj,
  organizationJsonLd$1 as ak,
  SITE_NAME$3 as al,
  AUTHOR_PERSON_ID as am,
  websiteJsonLd as an,
  Route$28 as ao,
  BREADCRUMBS as ap,
  FAQS$1 as aq,
  ...
  heroSrcSet as au,
  heroVariant as av,
  faqsForContentPage as aw,
  findAdvocacyState as ax,
  ADVOCACY_HUB_PATH as ay,
  ADVOCACY_STATES as az,
  Route$3i as b,
  resolve404 as b0,
  adminGetCourseSummary as b1,
  adminListLearners as b2,
  listLeads as b3,
  updateLeadStatus as b4,
  getSeoBatchDetails as b5,
  getIndexingStats as b6,
  adminImportGscRows as b7,
  Route$1d as b8,
  getEmailBranding as b9,
  ACADEMY_HUB_PATH as bA,
  submitProviderLead as bB,
  Route$M as bC,
  Route$L as bD,
  Route$K as bE,
  PATH as bF,
  LINKEDIN_URL as bG,
  AMAZON_AUTHOR_URL as bH,
  PRESS_URL as bI,
  BOOKS as bJ,
  cover as bK,
  amazonUrl as bL,
  Route$G as bM,
  Route$B as bN,
  adminGetLearnerDetail as bO,
  Route$A as bP,
  Route$1 as bQ,
  Route as bR,
  intercom_server as bS,
  router as bT,
  previewAuthEmail as ba,
  updateEmailBranding as bb,
  adminListPendingProviders as bc,
  adminGenerateProviderContent as bd,
  adminListProvidersMissingAI as be,
  adminUpdateProvider as bf,
  listContentPages as bg,
  bulkUpdateContentPages as bh,
  updateContentPage as bi,
  getContentPage as bj,
  listSectionPresets as bk,
  SECTION_PRESETS as bl,
  generateFullPageContent as bm,
  improvePageContent as bn,
  generateSeoMeta as bo,
  generateSectionPreset as bp,
  appendAiContentToPage as bq,
  generateCustomSection as br,
  deleteSectionPreset as bs,
  saveSectionPreset as bt,
  autoFixSeo as bu,
  Route$W as bv,
  adminReviewProviderClaim as bw,
  setAffiliateTierOverride as bx,
  listMyLearning as by,
  listMyProgress as bz,
  Route$2P as c,
  Route$2M as d,
  SiteFooter as e,
  Route$2J as f,
