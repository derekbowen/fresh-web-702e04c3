...
import { ai as Route, aj as cityTier, ak as buildFaqs, C as ComparisonPage, j as CTAPrimary, a2 as ComparisonTable, l as CTAMid, m as FAQList, A as AuthorBlock, p as FooterBlock } from "./router-Bk6RtsuF.js";
  ...
  return /* @__PURE__ */ jsxs(ComparisonPage, { competitor: "Giggster", title: `Giggster vs Pool Rental Near Me in ${city.name}`, effectiveMonthYear: "May 2026", children: [
    ...
    /* @__PURE__ */ jsxs("blockquote", { children: [
      ...
      isHub ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        ": production rates on Giggster (weekday) and recreational rates on Pool Rental Near Me (weekend). On a same-size host payout, PRNM's 10% commission keeps more in your pocket per booking; Giggster's premium per-hour production rates can make up the difference on a smaller number of larger bookings."
      ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        "For a typical residential pool in ",
        city.name,
        ", Pool Rental Near Me is the realistic channel — recreational demand is broadly distributed, while Giggster's production buyers concentrate in a handful of hub metros. PRNM's 10% host commission, included $2M Hartford liability on every approved booking, and pool-specific training are sized for residential pool hosting in ",
        city.name,
        "."
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs("p", { children: [
      ...
      city.name,
      " hosts a flat 10% host commission plus a 10% renter service fee. Hosts keep 90% of the booking subtotal."
    ] }),
    /* @__PURE__ */ jsx("div", { className: "not-prose my-6 overflow-x-auto rounded-2xl border border-border", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-muted/60 text-foreground", children: /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left font-semibold text-primary", children: "Keep on PRNM (10%)" }),
