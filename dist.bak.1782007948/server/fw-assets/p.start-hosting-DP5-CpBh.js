...
import { q as BREADCRUMBS, s as FAQS, t as heroImage } from "./router-Bk6RtsuF.js";
import { T as ToolPlaceholderPage } from "./tool-placeholder-B1TnVszN.js";
...
const WHY_EXISTS = {
  ...
  paragraphs: ["A backyard pool is one of the most underused assets in American real estate. The average residential pool gets swum in about 25 days a year. The other 340 days it sits idle, costing $200 to $500 a month in chemicals, electricity, and water — a recurring drain on your household budget that produces no income.", "Hosting flips that math. The same pool that's costing you $300 a month becomes one that's making you $3,000 a month — and in the right city, in season, $8,000 a month is normal, not exceptional. Hosts in Los Angeles, Phoenix, Miami, Houston, Dallas, and Atlanta routinely break $10,000 in peak July weekends alone.", "Pool Rental Near Me is built specifically for this. Flat 10% host fee — half of what Swimply charges. $2M liability insurance baked into every booking at no extra cost. Free to list, no monthly fees, payouts within 24 hours. The economics finally favor the person who actually owns the pool."]
};
const WHO_USES = {
...
const HOW_IT_WORKS = {
  ...
  steps: [{
    ...
    body: "Email and phone, no card required. Hosting is free to start — you keep 90% of every booking from day one."
  }, {
...
const PROPS = {
  ...
  intro: "Your backyard pool can pay for itself. Start hosting on Pool Rental Near Me with a flat 10% host fee, $2M liability on every booking, and 24-hour payouts. Free to list, no monthly cost, be live in 15 minutes.",
  heroSrc: heroImage,
  heroAlt: "Smiling pool host welcoming guests to a clean backyard pool on a sunny afternoon",
  bullets: ["Flat 10% host fee (Swimply charges 15–30%)", "$2,000,000 liability coverage on every booking", "24-hour payouts, free to list, no monthly fees", "Approve every guest or auto-approve trusted renters", "Pool Host Academy: 135 free classes to ramp up fast", "Free Host Pro app: pricing, calendar, waivers, taxes"],
