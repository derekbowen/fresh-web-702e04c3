...
import { S as SiteHeader, a4 as Breadcrumbs, aw as PATH, e as SiteFooter } from "./router-Bk6RtsuF.js";
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 pb-20 sm:pb-0", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-background", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-5xl px-4 py-14 sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-10 grid gap-6 md:grid-cols-2", children: [
          /* @__PURE__ */ jsx(EntityCard, { icon: Building2, name: "PRNM Corp", jurisdiction: "Delaware C-Corporation", description: "PRNM Corp operates Pool Rental Near Me, a peer-to-peer pool rental marketplace serving 40+ U.S. states. Every booking includes $2,000,000 in liability coverage. With a flat 10% host fee, PRNM Corp is the leading marketplace for pool hosts who want to keep more of what they earn.", brands: PRNM_BRANDS }),
