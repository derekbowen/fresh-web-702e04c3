...
import { S as SiteHeader, P as LAST_UPDATED, Q as faqs, e as SiteFooter } from "./router-BvRNdW25.js";
...
function FeesComparedPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-4xl px-4 py-10 text-slate-900", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-6 text-lg leading-relaxed", children: "Pool Rental Near Me charges hosts a 10% flat commission on every booking, the lowest published host fee of any major peer-to-peer pool rental marketplace. Swimply, Peerspace, and Giggster each take 15% or more from host earnings. Here is the side-by-side breakdown, sourced from each platform's published terms." }),
