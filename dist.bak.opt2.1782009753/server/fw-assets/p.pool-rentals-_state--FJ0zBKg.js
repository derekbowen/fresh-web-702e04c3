...
import { E as Route, S as SiteHeader, G as ListingCard, e as SiteFooter } from "./router-BvRNdW25.js";
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto w-full max-w-5xl flex-1 px-4 py-10 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("aside", { className: "mt-12 rounded-2xl border border-border bg-muted/30 p-6", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "mt-2 text-muted-foreground", children: [
          "Pool owners in ",
          stateName,
          " typically earn $3,000–$10,000 per month renting their backyard pool. You keep 90%, we charge a flat 10% host fee, and every booking includes $2M liability coverage."
        ] }),
