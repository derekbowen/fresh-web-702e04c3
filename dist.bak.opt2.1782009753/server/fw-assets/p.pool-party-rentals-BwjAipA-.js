...
import { S as SiteHeader, Y as heroImage, Z as FAQS, e as SiteFooter } from "./router-BvRNdW25.js";
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl px-4 py-12 sm:py-16", children: [
        /* @__PURE__ */ jsxs("article", { className: "prose prose-slate max-w-none text-foreground\n              prose-headings:font-semibold prose-headings:tracking-tight\n              prose-h2:mt-12 prose-h2:text-2xl prose-h2:border-b prose-h2:border-border prose-h2:pb-2\n              prose-h3:mt-8 prose-h3:text-xl\n              prose-p:leading-relaxed\n              prose-a:text-primary hover:prose-a:underline\n              prose-strong:text-foreground\n              prose-ul:my-4 prose-li:my-1.5\n              dark:prose-invert", children: [
          ...
          /* @__PURE__ */ jsx("p", { children: "Most pool party rentals on Pool Rental Near Me cost $40 to $200 per hour depending on group size, amenities, and city. Hosts set their own pricing, minimum hours, and house rules. You pay a flat 10% guest service fee on top of the hourly rate. Hosts keep 90% of every booking. We eat the credit card processing fees, so 90% means 90%." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "not-prose my-12 rounded-2xl border border-border bg-muted/40 p-6", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "Hosts who allow parties earn $2,000 to $10,000 a month renting their backyard pool by the hour. Flat 10% host fee, so you keep 90% of every booking. We eat the credit card processing fees, so 90% means 90%. $2M liability coverage included." }),
