...
import { sendDueEmails, pollSharetribeRenters } from "./renter-drip.server-D2A63B6b.js";
import { sendDueHostEmails, pollSharetribeHosts, enrollNewSignups } from "./host-drip.server-CML6Wr0O.js";
...
const appCss = "/fw-assets/styles-2qaJ6qka.css";
...
const $$splitComponentImporter$21 = () => import("./unsubscribe-renter-CHzs44f8.js");
...
const $$splitComponentImporter$20 = () => import("./unsubscribe-host-DC5Kj_Hq.js");
...
const $$splitComponentImporter$1$ = () => import("./unsubscribe-composer-RChMnLLg.js");
...
function HomePageInner({ data }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsx("section", { "aria-label": "Real swim days on Pool Rental Near Me", className: "bg-background", children: /* @__PURE__ */ jsxs("div", { className: "relative mx-auto h-[300px] w-full max-w-3xl px-4 py-2", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute left-4 top-8 w-[52%] -rotate-3", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-[22px] bg-white p-1.5", style: { boxShadow: "0 6px 18px rgba(34,48,60,0.14)" }, children: /* @__PURE__ */ jsx("img", { src: "/love-hero.jpg", alt: "Sunlit backyard pool", loading: "lazy", className: "h-[190px] w-full rounded-[18px] object-cover" }) }) }),
        /* @__PURE__ */ jsx("div", { className: "absolute right-4 top-0 w-[44%] rotate-2", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-[22px] bg-white p-1.5", style: { boxShadow: "0 6px 18px rgba(34,48,60,0.14)" }, children: [
          /* @__PURE__ */ jsx("img", { src: "/love-friends.jpg", alt: "Friends laughing poolside", loading: "lazy", className: "h-[230px] w-full rounded-[18px] object-cover" }),
          /* @__PURE__ */ jsx("span", { className: "absolute left-3 top-3 rounded-full px-3 py-1.5 text-[12px] font-extrabold text-white", style: { backgroundColor: "#0EA5E9" }, children: "Booked in 2 taps" })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "absolute bottom-2 right-5 z-10 flex h-[70px] w-[70px] flex-col items-center justify-center rounded-full text-white", style: { backgroundColor: "#ff6f52", boxShadow: "0 6px 18px rgba(34,48,60,0.2)" }, children: [
          /* @__PURE__ */ jsx("span", { className: "text-[19px] font-extrabold leading-none", children: "0%" }),
          /* @__PURE__ */ jsx("span", { className: "mt-0.5 text-[10px] font-extrabold leading-none", children: "host fees" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { "aria-label": "Why book with Pool Rental Near Me", className: "border-b border-border bg-secondary/30", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl gap-6 px-4 py-8 text-center sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-primary", children: "0%" }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold text-foreground", children: "Host fees through 2026" }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: "Hosts keep every dollar" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("section", { "aria-label": "Love notes from swimmers and hosts", className: "bg-background", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-4 py-12 sm:px-6", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-extrabold tracking-tight text-foreground sm:text-3xl", children: "Love notes 💌" }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Five hearts is our whole review system." }),
        /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-4 sm:grid-cols-3", children: [
        ...
        ].map(([q, who, where]) => /* @__PURE__ */ jsxs("div", { className: "rounded-2xl p-5", style: { backgroundColor: "#e4f4fc" }, children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm tracking-wide", style: { color: "#ff6f52" }, children: "❤️❤️❤️❤️❤️" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-[15px] font-bold leading-relaxed text-foreground", dangerouslySetInnerHTML: { __html: q } }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-extrabold text-foreground", children: who }),
            /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-muted-foreground", children: where })
          ] })
        ] }, who)) })
      ] }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-start gap-4 sm:gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative mt-3 inline-block rounded-2xl bg-card px-4 py-2 text-sm font-medium text-foreground shadow-md ring-1 ring-border sm:text-base", children: [
                /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Hi, I’m Fred! 👋" }),
                " I teach pool people how to earn more and stress less.",
                /* @__PURE__ */ jsx("div", { className: "absolute -left-1.5 top-4 h-3 w-3 rotate-45 bg-card ring-1 ring-border" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 max-w-2xl text-base text-muted-foreground sm:text-lg", children: "193 free classes on safety, pricing, marketing, AI tools, guest experience, and the highest-paying booking niches. Five minutes each. Zero homework, all heart — Fred wrote the playbook." }),
...
const $$splitComponentImporter$1Z = () => import("./landing-page-DsdNzCG7.js");
...
const $$splitComponentImporter$1Y = () => import("./auth-CAChDVj-.js");
const SAFE_PATH = /^\/(?!\/|\\)[^\s]*$/;
...
const $$splitComponentImporter$1W = () => import("./index-CjM88lXj.js");
...
const $$splitNotFoundComponentImporter$b = () => import("./verify._uid-CyTc0sHg.js");
const $$splitComponentImporter$1V = () => import("./verify._uid-B1EvdGSC.js");
...
const $$splitComponentImporter$1U = () => import("./p.waiver-generator-aKWsNlJe.js");
...
const $$splitComponentImporter$1T = () => import("./p.swimply-alternative-vs-pool-rental-near-me-C52SGf2y.js");
...
const $$splitComponentImporter$1S = () => import("./p.start-hosting-LrLJPijL.js");
...
const $$splitComponentImporter$1R = () => import("./p.sharetribe-EFJACdcq.js");
...
const $$splitComponentImporter$1Q = () => import("./p.private-pool-rental-DXknPsSa.js");
...
const $$splitComponentImporter$1P = () => import("./p.privacy-request-B8SsXRMg.js");
...
const $$splitComponentImporter$1O = () => import("./p.pool-wifi-guide-h6sO1lGl.js");
...
const $$splitComponentImporter$1N = () => import("./p.pool-rules-generator-D_sHL6vt.js");
...
const $$splitComponentImporter$1M = () => import("./p.pool-rentals-__state_-C8aMn8Vs.js");
const $$splitErrorComponentImporter$d = () => import("./p.pool-rentals-__state_-BiRzY7tO.js");
const $$splitNotFoundComponentImporter$a = () => import("./p.pool-rentals-__state_-CuSq3kuq.js");
...
const $$splitComponentImporter$1L = () => import("./p.pool-rentals-C02GdWl9.js");
const $$splitErrorComponentImporter$c = () => import("./p.pool-rentals-D-3DlQOg.js");
...
const $$splitComponentImporter$1K = () => import("./p.pool-rental-permits-by-state-1aDH1qlO.js");
...
const $$splitComponentImporter$1J = () => import("./p.pool-rental-insurance-explained-D5ab7Pvy.js");
...
const $$splitComponentImporter$1I = () => import("./p.pool-rental-host-fees-compared-Cu9FZzhd.js");
...
const $$splitComponentImporter$1H = () => import("./p.pool-rental-app-CRyQq9Kg.js");
...
const $$splitComponentImporter$1G = () => import("./p.pool-pros-Dxuawv8j.js");
...
const $$splitComponentImporter$1F = () => import("./p.pool-party-rentals-DtFXyiQ7.js");
...
const $$splitComponentImporter$1E = () => import("./p.pool-heating-cost-calculator-CjBA-qDr.js");
...
const $$splitComponentImporter$1D = () => import("./p.peerspace-vs-pool-rental-near-me-in-__city_-4p5JQTC5.js");
...
const $$splitComponentImporter$1C = () => import("./p.peerspace-vs-pool-rental-near-me-BYoMg4rT.js");
...
const $$splitComponentImporter$1B = () => import("./p.neighbors-BVi-GEOc.js");
...
const $$splitComponentImporter$1A = () => import("./p.lukes-lounge-BvnatgxY.js");
...
const $$splitComponentImporter$1z = () => import("./p.la-saltwater-featured-rIv3Z6yZ.js");
...
const $$splitComponentImporter$1y = () => import("./p.jan-BA6viB8J.js");
...
const $$splitComponentImporter$1x = () => import("./p.how-it-works-B0dGMAAh.js");
...
const $$splitComponentImporter$1w = () => import("./p.hosting-C_QCU1fe.js");
...
const $$splitComponentImporter$1v = () => import("./p.host-marketing-playbook--K9hulaZ.js");
...
const $$splitComponentImporter$1u = () => import("./p.giggster-vs-pool-rental-near-me-in-__city_-CEF8SccB.js");
...
const $$splitComponentImporter$1t = () => import("./p.giggster-vs-pool-rental-near-me-C0KbxPsI.js");
...
const $$splitComponentImporter$1s = () => import("./p.free-host-tools-liCyXHVI.js");
...
const $$splitComponentImporter$1r = () => import("./p.earnings-calculator-C0nrssIY.js");
...
const $$splitComponentImporter$1p = () => import("./p.blog-BEGeJuIQ.js");
...
const $$splitComponentImporter$1o = () => import("./p.all-locations-DxUOOuho.js");
...
const $$splitComponentImporter$1n = () => import("./p.ai-listing-generator-8A1sXlOF.js");
...
const $$splitComponentImporter$1m = () => import("./p.affiliate-program-CxD6FNti.js");
...
const $$splitComponentImporter$1l = () => import("./p.affiliate-dashboard-D0FlkGma.js");
...
const $$splitComponentImporter$1k = () => import("./p.affiliate-DDlm4_aJ.js");
...
const $$splitComponentImporter$1j = () => import("./p.about-our-company-Ctpt9Bni.js");
...
const $$splitNotFoundComponentImporter$7 = () => import("./p._slug-C-4NZwpf.js");
const $$splitErrorComponentImporter$b = () => import("./p._slug-DxMKks-6.js");
const $$splitComponentImporter$1i = () => import("./p._slug-aXOEQJnq.js");
...
const $$splitComponentImporter$1g = () => import("./auth.reset-password--pw3BB-R.js");
...
const $$splitComponentImporter$1f = () => import("./admin.tech-docs-DNmW4RyO.js");
...
const $$splitComponentImporter$1e = () => import("./admin.team-DwJsSHDr.js");
...
const $$splitComponentImporter$1d = () => import("./admin.social-lead-hunter-B8q1gvSv.js");
...
const $$splitComponentImporter$1c = () => import("./admin.sms-blast-DB-W1AJV.js");
...
const $$splitComponentImporter$1b = () => import("./admin.site-footer-CsR8D3nF.js");
const Route$1Q = createFileRoute("/admin/site-footer")({
  component: lazyRouteComponent($$splitComponentImporter$1b, "component")
});
const $$splitComponentImporter$1a = () => import("./admin.sharetribe-prune-CL6wkM16.js");
...
const $$splitComponentImporter$19 = () => import("./admin.sharetribe-Dd47rLm7.js");
const Route$1O = createFileRoute("/admin/sharetribe")({
  component: lazyRouteComponent($$splitComponentImporter$19, "component")
});
const $$splitComponentImporter$18 = () => import("./admin.seo-health-uoZU-mMq.js");
...
const $$splitComponentImporter$17 = () => import("./admin.seo-critic-DYK1veQ2.js");
...
const $$splitComponentImporter$16 = () => import("./admin.seo-coach-NvM_4Kga.js");
const Route$1L = createFileRoute("/admin/seo-coach")({
  component: lazyRouteComponent($$splitComponentImporter$16, "component")
});
const $$splitComponentImporter$15 = () => import("./admin.scrape-import-CGLKwP7m.js");
...
const $$splitComponentImporter$13 = () => import("./admin.redirect-aliases-W8cvYrKL.js");
...
const $$splitComponentImporter$12 = () => import("./admin.rank-tracker-B0i3eZ8g.js");
...
const $$splitComponentImporter$11 = () => import("./admin.quick-page-CB0SVGln.js");
...
const $$splitComponentImporter$10 = () => import("./admin.prnm-coach-BjOOPErl.js");
const Route$1F = createFileRoute("/admin/prnm-coach")({
  component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
const $$splitComponentImporter$$ = () => import("./admin.privacy-requests-7eexa8O1.js");
...
const $$splitErrorComponentImporter$a = () => import("./admin.plan-requests-Dwz0xVP8.js");
const $$splitComponentImporter$_ = () => import("./admin.plan-requests-DB3YrxoS.js");
...
const $$splitComponentImporter$Z = () => import("./admin.page-health-DqZEu7cS.js");
...
const $$splitComponentImporter$Y = () => import("./admin.page-auditor-BGA7cmI6.js");
...
const $$splitComponentImporter$X = () => import("./admin.opportunities-DziCxWiK.js");
const Route$1A = createFileRoute("/admin/opportunities")({
  component: lazyRouteComponent($$splitComponentImporter$X, "component")
});
const $$splitComponentImporter$W = () => import("./admin.no-access-B3PtIpoO.js");
...
const $$splitComponentImporter$V = () => import("./admin.missing-pages-D_i9gXNF.js");
...
const $$splitComponentImporter$T = () => import("./admin.listing-auditor-BxPkSWNc.js");
...
const $$splitComponentImporter$S = () => import("./admin.link-checker-CKswBsfv.js");
...
const $$splitComponentImporter$R = () => import("./admin.link-auto-repair-DS3cxjoJ.js");
...
const $$splitComponentImporter$Q = () => import("./admin.link-audit-B1Q1wIBW.js");
const Route$1t = createFileRoute("/admin/link-audit")({
  component: lazyRouteComponent($$splitComponentImporter$Q, "component")
});
const $$splitComponentImporter$P = () => import("./admin.learning-nceQmskG.js");
...
const $$splitComponentImporter$O = () => import("./admin.leads-CZY_hNEL.js");
...
const $$splitComponentImporter$N = () => import("./admin.landing-link-check-CtjWNMby.js");
const Route$1q = createFileRoute("/admin/landing-link-check")({
  component: lazyRouteComponent($$splitComponentImporter$N, "component")
});
const $$splitComponentImporter$M = () => import("./admin.keyword-opportunities-CjUo3qcP.js");
...
const $$splitComponentImporter$L = () => import("./admin.job-history-BCyr9jdh.js");
...
const $$splitComponentImporter$K = () => import("./admin.internal-links-B6bzdDe4.js");
...
const $$splitComponentImporter$J = () => import("./admin.indexing-D1FXHP3J.js");
...
const $$splitComponentImporter$I = () => import("./admin.ig-lead-hunter-BaSOG7yd.js");
...
const $$splitComponentImporter$G = () => import("./admin.gsc-import-DtRo5BAC.js");
...
const $$splitComponentImporter$F = () => import("./admin.generate-content-BCz8l9g3.js");
const Route$1i = createFileRoute("/admin/generate-content")({
  component: lazyRouteComponent($$splitComponentImporter$F, "component")
});
const $$splitComponentImporter$E = () => import("./admin.founder-blast-DLn3MSPK.js");
...
const $$splitComponentImporter$D = () => import("./admin.followup-reminders-CyMQJsQe.js");
const Route$1g = createFileRoute("/admin/followup-reminders")({
  component: lazyRouteComponent($$splitComponentImporter$D, "component")
});
const $$splitComponentImporter$C = () => import("./admin.followup-performance-NLZL_WLW.js");
const Route$1f = createFileRoute("/admin/followup-performance")({
  component: lazyRouteComponent($$splitComponentImporter$C, "component")
});
const $$splitComponentImporter$B = () => import("./admin.followup-drilldown-DMj1trSZ.js");
const searchSchema = z.object({
...
const $$splitComponentImporter$A = () => import("./admin.follow-ups-C_bwM1Ft.js");
const Route$1d = createFileRoute("/admin/follow-ups")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./admin.faq-generator-XNcFHYz0.js");
const Route$1c = createFileRoute("/admin/faq-generator")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./admin.email-verify-D8O_WRBI.js");
...
const $$splitComponentImporter$x = () => import("./admin.email-queue-B54pT9TM.js");
...
const $$splitComponentImporter$w = () => import("./admin.email-deliverability-DgYQM-A-.js");
...
const $$splitComponentImporter$v = () => import("./admin.email-composer-bnlHMUAh.js");
...
const $$splitComponentImporter$u = () => import("./admin.email-branding-D3z_YdQ8.js");
...
const $$splitComponentImporter$t = () => import("./admin.drip-subscribers-B2ObIEEF.js");
const Route$16 = createFileRoute("/admin/drip-subscribers")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./admin.directory-BK95R__E.js");
...
const $$splitComponentImporter$r = () => import("./admin.data-import-4vRutfEj.js");
...
const $$splitComponentImporter$q = () => import("./admin.data-export-Vmt78JbN.js");
...
const $$splitComponentImporter$p = () => import("./admin.dashboard-BiJxEtk7.js");
...
const $$splitComponentImporter$o = () => import("./admin.content-pages-CwZY8Iqi.js");
...
const $$splitComponentImporter$n = () => import("./admin.content-migration-CcCc8Udj.js");
...
const $$splitComponentImporter$m = () => import("./admin.content-health-DcS-iivv.js");
...
const $$splitComponentImporter$l = () => import("./admin.competitors-BwEJb37O.js");
...
const $$splitComponentImporter$k = () => import("./admin.competitor-radar-DME5kWgW.js");
...
const $$splitComponentImporter$j = () => import("./admin.click-report-DjYdp4Bb.js");
...
const $$splitErrorComponentImporter$8 = () => import("./admin.claims-1z2DeZtg.js");
const $$splitComponentImporter$i = () => import("./admin.claims-C6gaM_lh.js");
...
const $$splitComponentImporter$h = () => import("./admin.cities-heroes-report-BuXj0RoC.js");
...
const $$splitComponentImporter$g = () => import("./admin.cities-heroes-Bf9vX6cz.js");
...
const $$splitComponentImporter$f = () => import("./admin.blog-1tClTWqo.js");
...
const $$splitComponentImporter$e = () => import("./admin.auto-refresh-BhaV9Uhv.js");
...
const $$splitErrorComponentImporter$7 = () => import("./admin.auto-outreach-CDRX6xk3.js");
const $$splitComponentImporter$d = () => import("./admin.auto-outreach-nM-d5JAt.js");
...
const $$splitComponentImporter$c = () => import("./admin.affiliates-C4KYT2cG.js");
...
const $$splitComponentImporter$b = () => import("./admin.add-contacts-vKvI48h3.js");
...
const $$splitComponentImporter$a = () => import("./admin.activity-cities-B5G8CDU5.js");
const Route$P = createFileRoute("/admin/activity-cities")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./account.learning-CSPSxLlc.js");
...
const $$splitNotFoundComponentImporter$6 = () => import("./p.pool-pros._slug-BsokYY2R.js");
const $$splitErrorComponentImporter$6 = () => import("./p.pool-pros._slug-ib0-r6ey.js");
const $$splitComponentImporter$8 = () => import("./p.pool-pros._slug-DO5cBc8U.js");
...
const $$splitNotFoundComponentImporter$5 = () => import("./p.es._slug-mWOxWO4K.js");
const $$splitErrorComponentImporter$5 = () => import("./p.es._slug-DkbQUHoa.js");
const $$splitComponentImporter$7 = () => import("./p.es._slug-BtepKJ6s.js");
const ES_TO_EN_SLUG = {
...
const $$splitNotFoundComponentImporter$4 = () => import("./p.course._slug-DP0l4bMM.js");
const $$splitErrorComponentImporter$4 = () => import("./p.course._slug-CGT6-iPT.js");
const $$splitComponentImporter$6 = () => import("./p.course._slug-cCxxqRYt.js");
...
const $$splitComponentImporter$5 = () => import("./p.author.derek-bowen-4AmjzfTt.js");
...
const $$splitNotFoundComponentImporter$3 = () => import("./l._slug._id-Cyh8-suu.js");
const $$splitErrorComponentImporter$3 = () => import("./l._slug._id-CkixuMUO.js");
const $$splitComponentImporter$4 = () => import("./l._slug._id-D0KqMscu.js");
...
const $$splitComponentImporter$3 = () => import("./admin.learning._userId--cWXEhgp.js");
...
const $$splitErrorComponentImporter$2 = () => import("./p.pool-pros.c._category-C99SzXFg.js");
const $$splitNotFoundComponentImporter$2 = () => import("./p.pool-pros.c._category-B4r8JlAW.js");
const $$splitComponentImporter$2 = () => import("./p.pool-pros.c._category-tDOzlVr0.js");
...
const $$splitErrorComponentImporter$1 = () => import("./p.pool-pros.c._category._state-DSy6csmZ.js");
const $$splitNotFoundComponentImporter$1 = () => import("./p.pool-pros.c._category._state-DIP_K9yI.js");
const $$splitComponentImporter$1 = () => import("./p.pool-pros.c._category._state-vTedxzG5.js");
...
const $$splitErrorComponentImporter = () => import("./p.pool-pros.c._category._state._city-DM3I2zs5.js");
const $$splitNotFoundComponentImporter = () => import("./p.pool-pros.c._category._state._city-DM3UNv_4.js");
const $$splitComponentImporter = () => import("./p.pool-pros.c._category._state._city-svfz2fbc.js");
