    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {user ? (
          ...
          <Link to="/auth" className="inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-sm hover:opacity-95">
            Sign in to post
          </Link>
        )}
      </div>
