          ...
          <div className="mx-auto w-full max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <EntityCard
                ...
                description="PRNM Corp operates Pool Rental Near Me, a peer-to-peer pool rental marketplace serving 40+ U.S. states. With 0% host fees, PRNM Corp is the leading marketplace for pool hosts who want to keep more of what they earn."
                brands={PRNM_BRANDS}
              />
              <EntityCard
                icon={Briefcase}
