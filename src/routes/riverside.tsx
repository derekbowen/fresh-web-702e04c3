...
const CITY = "Riverside", ST = "CA";
const POOLS = listingsNear(33.9533, -117.3962, 35);
const HOODS = [{ label: "Corona hosts", href: "/p/become-a-swimming-pool-host-corona-ca" }, { label: "Murrieta hosts", href: "/p/become-a-swimming-pool-host-murrieta-ca" }, { label: "Menifee hosts", href: "/p/become-a-swimming-pool-host-menifee-ca" }, { label: "Moreno Valley hosts", href: "/p/become-a-swimming-pool-host-moreno-valley-ca" }];

export const Route = createFileRoute("/riverside")({
  head: () => buildMeta({
        ...
        <section className="border-b border-border py-12 sm:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a href="/p/become-a-swimming-pool-host-riverside-ca" className="rounded-lg border border-border px-5 py-3 font-semibold text-foreground">
        ...
        <section className="border-b border-border py-10 sm:py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 flex flex-wrap gap-4 text-sm font-medium text-primary">
              ...
              <a href="/p/become-a-swimming-pool-host-riverside-ca" className="hover:underline">How hosting works in {CITY} →</a>
            </div>
          </div>
        </section>
