...
export const SECTION_PRESETS = [
  ...
  { key: "insurance", label: "Insurance & liability", prompt: "Add an 'Insurance and liability' section. Do NOT make any statement about PRNM's own insurance, in either direction — never name a carrier or cite coverage amounts. Explain that hosts must carry their own coverage, that most homeowners policies exclude paid rentals, and what to ask their own agent." },
