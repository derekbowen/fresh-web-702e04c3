  ...
  switch (variant) {
    case "A":
      return {
        ...
        metaDescription: `Turn your ${cityName} pool into income. List on Pool Rental Near Me — 0% host fees, $2M liability included, full control of your schedule and rates.`,
    ...
    case "B":
      return {
        ...
        metaDescription: `Rent out your pool in ${cityName} by the hour. Free to list, 0% host fees, $2M liability per booking, payouts via Stripe. List your pool today.`,
