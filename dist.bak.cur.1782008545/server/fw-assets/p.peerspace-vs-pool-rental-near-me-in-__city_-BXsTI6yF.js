...
import { a0 as Route, a1 as buildFaqs, C as ComparisonPage, j as CTAPrimary, a2 as ComparisonTable, l as CTAMid, m as FAQList, A as AuthorBlock, p as FooterBlock } from "./router-HDJJ1Z-a.js";
...
function PeerspaceCityPage() {
  ...
  const tableRows = [{
    ...
    prnm: /* @__PURE__ */ jsx("strong", { children: "$270" }),
    competitor: "$240"
  }, {
  ...
  return /* @__PURE__ */ jsxs(ComparisonPage, { competitor: "Peerspace", title: `Peerspace vs Pool Rental Near Me in ${city.name}`, effectiveMonthYear: "May 2026", children: [
    ...
    /* @__PURE__ */ jsxs("blockquote", { children: [
      ...
      " Pool Rental Near Me's 10% host fee is half of Peerspace's 20%, and the $2M liability is double. For typical ",
      city.name,
    ...
    /* @__PURE__ */ jsxs("ul", { children: [
      /* @__PURE__ */ jsxs("li", { children: [
        /* @__PURE__ */ jsx("strong", { children: "Pool Rental Near Me (10% fee):" }),
        " you keep $270"
      ] }),
      /* @__PURE__ */ jsxs("li", { children: [
