...
import { S as SiteHeader, N as LAST_UPDATED, O as faqs, e as SiteFooter } from "./router-OI82CwOi.js";
...
function InsuranceExplainedPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-4xl px-4 py-10 text-slate-900", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold leading-tight md:text-4xl", children: "Pool rental insurance, explained: what each platform actually covers" }),
