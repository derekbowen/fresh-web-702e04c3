...
import { S as SiteHeader, t as heroImage, ae as ACADEMY_HREF, af as FAQS, e as SiteFooter } from "./router-OI82CwOi.js";
...
const COMPARE = [["Host service fee", "15–30% (varies)", "10% (flat)"], ["Hosts keep", "70–85%", "90%"], ["Liability coverage", "$1,000,000", "$2,000,000"], ["Payout speed", "48 hr + 3–7 days to bank", "24 hr + 1–3 days to bank"], ["Fee predictability", "Varies by tier", "Same 10% always"], ["Host education", "Webinars, help articles", "135 free classes (Pool Host Academy)"], ["Host community", "Facebook group", "Private board (PRNM Connect)"], ["Listing fee", "Free", "Free"]];
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("section", { ref: heroRef, className: "bg-sky-50", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:py-24 lg:grid-cols-2 lg:items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl", children: "Swimply's host fee runs 15% to 30% per booking. Ours is a flat 10%. Plus $2M coverage versus their $1M, money in your bank 4–7 days faster, and 135 free classes on hosting. No other platform does that." }),
          ...
          /* @__PURE__ */ jsx("ul", { className: "mt-8 grid grid-cols-2 gap-3 text-sm text-foreground sm:flex sm:flex-wrap sm:gap-x-6 sm:gap-y-2", children: ["Free to list", "10% flat host fee", "$2M liability per booking", "135 free classes"].map((t) => /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-1.5", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "border-t border-border bg-background py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl px-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3", children: [{
          ...
          title: "Start hosting",
          body: "Earn $1,500–$8,000/month — flat 10% fee, $2M coverage."
        }, {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "90% of gross — flat 10% PRNM host fee" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs italic text-muted-foreground", children: "Plus your guest pays 10% to PRNM separately. We never touch your share." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "my-6 h-px bg-border" }),
        /* @__PURE__ */ jsxs("div", { children: [
