...
import { ax as HERO_SIZES, ay as heroSrcSet, az as heroVariant, aA as faqsForContentPage, S as SiteHeader, e as SiteFooter, aB as findAdvocacyState, aC as ADVOCACY_HUB_PATH, aD as ADVOCACY_STATES, aE as relatedAdvocacyStates, aF as normalizeTitleVariant, aG as getVariantCopy, aH as AUTHOR_PERSON_JSONLD_REF, aI as academyHubPath, aJ as FredMascot, aK as FloatingFredTip, aL as Route, aM as academyLangForSlug } from "./router-OI82CwOi.js";
import { Link } from "@tanstack/react-router";
import ReactMarkdown from "react-markdown";
import remarkGfm from "remark-gfm";
import { A as AuthorByline, R as RelatedPages, F as FounderBookingInline, G as GenericPageTemplate } from "./generic-page-Cq9rLJ3D.js";
import { B as BreadcrumbsWithSchema } from "./breadcrumbs-jsonld-B-wmOM2n.js";
...
import { I as I18N, L as LanguageSwitcher, C as CourseCard, g as getCategoryMeta } from "./language-switcher-BFx7zBQk.js";
...
function SidebarCTA({ stateName }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-3xl bg-gradient-to-br from-primary to-primary-glow p-6 text-primary-foreground shadow-xl", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-primary-foreground/85", children: "Free to list. $2M liability on every confirmed booking. 10% flat host fee." }),
      /* @__PURE__ */ jsx(
        "a",
        {
      ...
      /* @__PURE__ */ jsx("section", { className: "mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-12", children: [
        /* @__PURE__ */ jsxs("article", { className: "lg:col-span-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-14 rounded-3xl border border-border bg-gradient-to-br from-primary/10 via-card to-card p-6 sm:p-8", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-xl text-sm text-muted-foreground", children: "Free to list. $2M liability insurance on every confirmed booking. 10% flat host fee — the lowest of any pool rental platform." }),
...
function EarningsCalculator({
  ...
  return /* @__PURE__ */ jsxs("section", { className: "mt-12 rounded-2xl border border-border bg-card p-6 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-6 text-xs text-muted-foreground", children: "Estimates are illustrative and depend on demand, season, photo quality, and how quickly you respond to bookings. Pool Rental Near Me takes a flat 10% host fee — already excluded from the numbers above is nothing, these figures are gross. Subtract 10% for net." })
  ] });
}
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-5 lg:px-8 lg:py-28", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-border bg-card/95 p-6 shadow-2xl backdrop-blur", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-3 gap-3 border-t border-border pt-5 text-center", children: [
              /* @__PURE__ */ jsx(Stat, { label: "Host fee", value: "10%", sub: "vs 15%+" }),
...
function MidContentCta() {
  return /* @__PURE__ */ jsxs("aside", { className: "not-prose my-10 overflow-hidden rounded-2xl border-2 border-primary/40 bg-primary/5 p-5 sm:p-6", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm leading-relaxed text-muted-foreground", children: "Owners on Pool Rental Near Me earn money renting their pool by the hour — no membership, flat 10% host fee, $2M liability insurance included." }),
...
function PrnmCta() {
  return /* @__PURE__ */ jsxs("aside", { className: "mt-14 overflow-hidden rounded-2xl border-2 border-primary/40 bg-gradient-to-br from-primary/15 to-primary/5 p-6 sm:p-8", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-3 max-w-2xl text-base text-muted-foreground", children: "Hosts on Pool Rental Near Me earn $3K–$10K/month renting their pool by the hour. Flat 10% host fee (vs Swimply's 15%+), $2M liability insurance included, you set the rules. Listing takes 10 minutes." }),
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 overflow-hidden rounded-xl border border-border bg-background", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-border", children: [
            /* @__PURE__ */ jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: "10% flat" }),
