...
import { S as SiteHeader, a4 as Breadcrumbs, bJ as PATH, bK as LINKEDIN_URL, bL as AMAZON_AUTHOR_URL, bM as PRESS_URL, bN as BOOKS, bO as cover, bP as amazonUrl, e as SiteFooter } from "./router-OI82CwOi.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-background", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-3xl px-4 py-14 text-center sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "List your pool on Pool Rental Near Me. Flat 10% host fee, $2M liability coverage included, and you keep your calendar in your control." }),
