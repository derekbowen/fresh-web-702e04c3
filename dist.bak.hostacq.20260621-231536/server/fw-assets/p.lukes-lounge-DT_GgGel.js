...
import { a6 as Route, S as SiteHeader, e as SiteFooter } from "./router-OI82CwOi.js";
import { Camera, MapPin, Droplets, Ruler, Calendar, Flame, Lock, Sparkles, ShieldCheck, Check, Sun, Music, Trees, Gift, ListChecks, ChevronLeft, ChevronRight } from "lucide-react";
...
const url = "/__l5e/assets-v1/d3b96c31-b155-4497-88a5-4a10c3cf9dde/lukes-lounge-reel.mp4";
const lukesReel = {
  url
};
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "bg-background pb-20", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "mx-auto mt-8 max-w-7xl px-4", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-3 flex items-end justify-between", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-foreground md:text-3xl", children: "Watch the tour" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "60 seconds inside Luke's Lounge" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-2xl bg-black shadow-xl ring-1 ring-border", children: /* @__PURE__ */ jsx("video", { src: lukesReel.url, poster: heroImg || void 0, controls: true, playsInline: true, preload: "metadata", className: "aspect-video w-full" }) })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "mx-auto mt-8 max-w-7xl px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 md:flex-row md:items-start md:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-2xl", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold tracking-tight text-foreground md:text-4xl", children: listing.title }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground", children: [
            locStr && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4" }),
              locStr
            ] }),
            listing.poolType && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 capitalize", children: [
              /* @__PURE__ */ jsx(Droplets, { className: "h-4 w-4" }),
              listing.poolType,
              " ",
              listing.waterType
            ] }),
            listing.poolSize && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 capitalize", children: [
              /* @__PURE__ */ jsx(Ruler, { className: "h-4 w-4" }),
              listing.poolSize,
              " pool"
            ] }),
            /* @__PURE__ */ jsx("a", { href: listing.bookUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-1 text-primary hover:underline", children: "View on Pool Rental Near Me ↗" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start gap-3 rounded-2xl border border-border bg-card p-5 shadow-sm md:items-end", children: [
          ...
          /* @__PURE__ */ jsxs("a", { href: listing.bookUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-sm transition-transform hover:scale-[1.02]", children: [
            /* @__PURE__ */ jsx(Calendar, { className: "h-4 w-4" }),
            "Check availability & book"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Free cancellation up to 2 hours before · Opens in new tab" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "mx-auto mt-10 max-w-7xl px-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 md:grid-cols-4", children: [
        /* @__PURE__ */ jsx(Fact, { icon: Droplets, label: "Saltwater pool", sub: "Inground" }),
        /* @__PURE__ */ jsx(Fact, { icon: Flame, label: "Heated", sub: "Year-round swimmable" }),
        /* @__PURE__ */ jsx(Fact, { icon: Lock, label: "Fully fenced", sub: "Private + secure" }),
        /* @__PURE__ */ jsx(Fact, { icon: Sparkles, label: "Pool cleaning", sub: "Included with booking" })
      ] }) }),
      /* @__PURE__ */ jsxs("section", { className: "mx-auto mt-12 grid max-w-7xl gap-12 px-4 md:grid-cols-3", children: [
        ...
        /* @__PURE__ */ jsx("aside", { className: "md:sticky md:top-24 md:self-start", children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: listing.bookUrl, target: "_blank", rel: "noopener noreferrer", className: "mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 text-sm font-semibold text-primary-foreground shadow-sm transition-transform hover:scale-[1.02]", children: "Book now" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-5 space-y-3 text-sm text-foreground/85", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Free cancellation up to 2 hours before" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsx(Check, { className: "mt-0.5 h-4 w-4 text-primary" }),
              /* @__PURE__ */ jsx("span", { children: "10% flat host fee, no surprises" })
            ] })
          ] })
        ] }) })
      ] }),
      ...
      listing.amenities.length > 0 && /* @__PURE__ */ jsxs("section", { className: "mx-auto mt-16 max-w-7xl px-4", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "All free with your booking unless noted." }),
      ...
      extraPhotos.length > 0 && /* @__PURE__ */ jsxs("section", { className: "mx-auto mt-16 max-w-7xl px-4", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-end justify-between", children: /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm text-muted-foreground", children: [
            "All ",
            totalPhotos,
            " photos of Luke's Lounge — tap any photo to enlarge."
          ] })
        ] }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "mx-auto mt-20 max-w-4xl px-4 text-center", children: /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-border bg-gradient-to-br from-primary/5 to-card p-10", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-foreground md:text-3xl", children: "Ready to dive in?" }),
        /* @__PURE__ */ jsxs("p", { className: "mx-auto mt-3 max-w-xl text-foreground/75", children: [
          listing.guests ? `Up to ${listing.guests} guests. ` : "",
          "Pick your date and time, book in under 2 minutes. Full refund if you cancel 2+ hours before."
        ] }),
        /* @__PURE__ */ jsxs("a", { href: listing.bookUrl, target: "_blank", rel: "noopener noreferrer", className: "mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-8 py-4 text-base font-semibold text-primary-foreground shadow-md transition-transform hover:scale-[1.02]", children: [
          /* @__PURE__ */ jsx(Calendar, { className: "h-5 w-5" }),
          "Book Luke's Lounge — $",
          listing.pricePerHour,
          "/hour"
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-xs text-muted-foreground", children: "10% flat host fee · $2M liability insurance included" })
      ] }) })
    ] }),
