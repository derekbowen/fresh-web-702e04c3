...
import { an as Route, ao as organizationJsonLd, I as SITE_URL, S as SiteHeader, ap as SITE_NAME, e as SiteFooter, aq as AUTHOR_PERSON_ID, ar as websiteJsonLd } from "./router-BEu57YoG.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-6xl px-4 py-10", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "mt-16 overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 via-primary/5 to-background p-8 md:p-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-lg text-muted-foreground", children: "Hosts on Pool Rental Near Me earn $3,000 to $10,000 a month in summer. 0% host fees through 2026, $2 million liability coverage included on every booking, listings live in under 10 minutes." }),
